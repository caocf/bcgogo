...
public class DrivingTrackStatisticsItem extends LinearLayout {
	...
	protected void init() {
		...
		final int textSize = getResources().getInteger(R.integer.driving_track_statisics_item_text_sp);
		mValueText.setTextSize(TypedValue.COMPLEX_UNIT_SP , textSize);
		...
		mUnitText.setTextSize(TypedValue.COMPLEX_UNIT_SP, 12);
