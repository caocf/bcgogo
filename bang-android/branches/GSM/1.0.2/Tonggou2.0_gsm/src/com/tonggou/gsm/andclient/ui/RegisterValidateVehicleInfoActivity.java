...
public class RegisterValidateVehicleInfoActivity extends AbsVehicleManagerActivity {
	...
	void onTitleBarRightBtnClick() {
		doRegisterRequest(mPhoneNoStr, mPasswordStr, mIMEIStr,
	 ...
	 */
	private void doRegisterRequest(final String phoneNo, final String pwd, final String imei,
		...
		request.setRequestParams(phoneNo, pwd, imei, oilPrice, currentMileage, maintainPeriod, lastMaintainMileage, nextMaintainTime, nextExamineTime);
