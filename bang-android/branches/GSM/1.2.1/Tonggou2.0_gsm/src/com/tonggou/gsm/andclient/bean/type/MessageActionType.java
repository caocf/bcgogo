 ...
 * 	<li>{@link #ADVERT_DETAIL}公告详情. params 参数格式：公告单Id,shopId</li>
 * 	<li>{@link #VIOLATE_REGULATION_QUERY}违章查询 无参数</li>
 * </ul>
 * 
 * @author lwz
 *
...
public enum MessageActionType {
	...
	COMMENT_SHOP,
	/**
	 * 公告详情. params 参数格式：公告单Id,shopId
	 */
	ADVERT_DETAIL,
	/**
	 * 违章查询 无参数
	 */
	VIOLATE_REGULATION_QUERY
}
