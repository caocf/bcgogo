...
public class UpdateVehicleInfoRequest extends AbsTonggouHttpRequest {
	...
	public void setRequestParams(final String oilPrice, final String currentMileage, final String maintainPeriod,
		...
		setRequestParams(oilPrice, currentMileage, maintainPeriod, lastMaintainMileage, 
	...
	public void setRequestParams(final String juheCityName, final String juheCityCode, final String vehilceVin, final String registNo, final String engineNo) {
		...
		setRequestParams(vehicleInfo.getOilPrice(), String.valueOf(vehicleInfo.getCurrentMileage()),
