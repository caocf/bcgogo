...
public class GasStationDetailActivity extends GasStationBaseActivity {
	...
	private void receiveIntentData() {
		...
		mGasStations = data.getParcelableArrayListExtra(GAS_STATIONS);
	}
