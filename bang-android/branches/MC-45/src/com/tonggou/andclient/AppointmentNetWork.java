...
public class AppointmentNetWork extends BaseActivity{
	...
	private AlertDialog watingAlert;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		View appointmentAction = findViewById(R.id.register);
					...
					if(mobile!=null&&!"".equals(mobile)){
						if(SomeUtil.isPhoneNumberValid(mobile)){
							...
							if(appointmentTime.getText().toString()!=null&&nextInsuranceTimeLong>=nowTime){	
								watingAlert= new AlertDialog.Builder(AppointmentNetWork.this).create();
								watingAlert.show();			
								Window window = watingAlert.getWindow();
	...
	private void doAppointment(String serviceCategoryId,String appointTime,String mobile,String contact,
		...
		//		long pPid = 0;
		//		if(pinPaiId!=null&&!"".equals(pinPaiId)){
		//			pPid = Long.valueOf(pinPaiId);
		//		}
