...
import com.tonggou.gsm.andclient.ui.OnlineShopActivity;
import com.tonggou.gsm.andclient.ui.QueryVideoActivity;
...
public class LeftMenuFragment extends AbsMenuAdapterViewFragment implements OnItemClickListener, OnGotNewMessageListener {
	...
	private final int ITEM_POS_VIOLATION = 6;
	...
	Class<?>[] getDestActivitys() {
		return new Class<?>[]{
				AppointmentActivity.class, MessageManagerActivity.class,
				ShopNoticeActivity.class, VehicleDataStatisticActivity.class,
				QueryVideoActivity.class, OnlineShopActivity.class
			};
	}
