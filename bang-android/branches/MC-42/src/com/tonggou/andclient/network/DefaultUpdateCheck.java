...
//	}
	...
	protected UpgradeCheckParser sendUpdateCheckRequest() {
		...
		String url = INFO.HTTP_HEAD+INFO.HOST_IP+"/newVersion/platform/"+INFO.CLIENT_PLATFORM+"/appVersion/"+INFO.VERSION+"/platformVersion/"+URLEncoder.encode(TongGouApplication.platformVersion)+"/mobileModel/"+URLEncoder.encode(TongGouApplication.mobileModel);
