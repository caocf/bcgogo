...
public class TongGouApplication extends Application {
	...
	public void saveSomeInformation(LoginResponse loginResponse,
			SharedPreferences sharedPreferences, String userID, String userPassword) {
		if (userID != null && !"".equals(userID)) {
			sharedPreferences.edit().putString(BaseActivity.NAME, userID).commit();
		}
		if (userPassword != null && !"".equals(userPassword)) {
			sharedPreferences.edit().putString(BaseActivity.PASSWORD, userPassword).commit();
		}
	...
	// obdLists.get(i).getVehicleInfo().getVehicleBrand()).commit();
	// }
	// if(obdLists.get(i).getVehicleInfo().getVehicleModel()!=null){
	// getSharedPreferences(BaseActivity.SETTING_INFOS, 0).edit()
	// .putString(BaseActivity.MODEL,
	// obdLists.get(i).getVehicleInfo().getVehicleModel()).commit();
	// }
	...
	// obdLists.get(i).getVehicleInfo().getVehicleModelId()).commit();
	// }
	// }
	// }
	// }
