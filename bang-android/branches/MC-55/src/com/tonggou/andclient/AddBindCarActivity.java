...
public class AddBindCarActivity extends BaseActivity{
	...
	bindcarnexttime2Str,bindcarnum1Str,bindcarnum2Str,bindcarvehiclevinStr,bindcarenginenoStr,bindcarregistnoStr;
	...
	private EditText  bindcarnumber,bindcarnextmile,currentMileET,bindcarvehiclevin,bindcarengineno,bindcarregistno;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bindnewcar= findViewById(R.id.add_bindcar);                       //设备号
					...
					new Thread(){
						public void run(){
							...
							if(obdSNStr==null||"".equals(obdSNStr)){
								saveCarInfor("",obdVin,bindcarnumberStr,bindcarnum1Str,carMoldId,bindcarnum2Str,carBrandId,userNo);//,bindcarvehiclevinStr,bindcarenginenoStr,bindcarregistnoStr
							}else{
								bindObd(obdVin,bindcarnumberStr,bindcarnum1Str,carMoldId,bindcarnum2Str,carBrandId,obdSNStr,userNo,bindcarnextmileStr);//,bindcarenginenoStr,bindcarregistnoStr
							}
						}
					}.start();
				}
	...
	private void saveCarInfor(String vehicleId,String vehicleVin,String vehicleNo,String vehicleModel,
			String vehicleModelId,String vehicleBrand,String vehicleBrandId,String userNo){//,String vehiclevinStr,String enginenoStr,String registnoStr
		...
		String valuePairs ="{\"vehicleNo\":\""+vehicleNo.trim()+"\"," +
				...
				",\"nextExamineTime\":\""+nextExamineTimeLong+"\"" +current+nextmile+vehiclevin+engineno+registno+
				/*",\"obdSN\":\""+obdSN+"\"" +*/
				",\"userNo\":\""+userNo+"\"}";
