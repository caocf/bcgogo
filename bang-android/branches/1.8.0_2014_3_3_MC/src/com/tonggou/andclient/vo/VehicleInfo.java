...
public class VehicleInfo implements Parcelable{
	...
	public void setNextMaintainMileage(String nextMaintainMileage) {
		this.nextMaintainMileage = formatStrToLong(nextMaintainMileage);
	}
	...
	public void setCurrentMileage(String currentMileage) {
		this.currentMileage = formatStrToLong(currentMileage);
	}
	...
	private VehicleInfo(Parcel source){
		...
		nextMaintainMileage= source.readLong();
		...
		currentMileage= source.readLong();
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeLong(nextMaintainMileage);
	...
	private long formatStrToLong(String value) {
		try {
