...
public class DrivingJournalItem implements Serializable {
	...
	public String toString() {
		return "DrivingJournalItem [appDriveLogId=" + appDriveLogId + ", appUserNo=" + appUserNo
				+ ", vehicleNo=" + vehicleNo + ", startTime=" + startTime + ", startLat=" + startLat
				+ ", startLon=" + startLon + ", startPlace=" + startPlace + ", endTime=" + endTime
				+ ", endLat=" + endLat + ", endLon=" + endLon + ", endPlace=" + endPlace + ", travelTime="
				+ travelTime + ", distance=" + distance + ", oilWear=" + oilWear + ", oilKind=" + oilKind
				+ ", oilPrice=" + oilPrice + ", totalOilMoney=" + totalOilMoney + ", placeNotes="
				+ placeNotes + ", lastUpdateTime=" + lastUpdateTime + ", status=" + status + ", appPlatform="
				+ appPlatform + "]";
	}
