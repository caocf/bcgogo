...
public abstract class BaseActivity extends AbsUMengActivity {
	...
	// public static final String FAULT_DIC_VERSON = "fault_dic_version"; //
	// 具体车型故障码版本号
	...
	public static final String EXTRA_DEFAULT_OIL_PRICE = "extra_default_oil_price"; // 默认油价
	public static final String EXTRA_DEFAUL_TOIL_KIND = "extra_defaul_toil_kind"; // 默认油品
	...
	public static final String APPCONFIG_ERROR_ALERT_INTERVAL = "error_alert_Interval"; // 重复故障码提示间隔
																						// 单位为小时
	public static final String APPCONFIG_OIL_ALERT_INTERVAL = "oil_alert_Interval"; // 油量警告区间
																					// 15_25
	public static final String APPCONFIG_OIL_LAST_STATUS = "oil_alert_status"; // 油量上一次警告区间
																				// 0~15--0
																				// /
																				// 15~25--1/
																				// 25以上--2
	...
	public static final String LAST_CC_BATTERY_VOLTAGE = "last_cc_battery_voltage";
	public static final String LAST_CC_TANK_TEMPERATURE = "last_cc_tank_temperature";
	public static final String LAST_CC_AVG_OIL_WEAR = "last_cc_avg_oil_wear";
	public static final String LAST_CC_ON_ROAD_DISTANCE = "last_cc_on_road_distance";
	public static final String LAST_CC_ON_ROAD_TIME = "last_cc_on_road_time";
	...
	// public static HashMap<Integer, Integer> soundPoolMap = new
	...
	public void setLikes(String like, ImageView like1, ImageView like2, ImageView like3, ImageView like4,
			ImageView like5) {
							...
							if (Double.parseDouble(like) <= 2.5) {
								...
								if (Double.parseDouble(like) <= 3.0) {
									...
									if (Double.parseDouble(like) <= 3.5) {
										like1.setImageDrawable(getResources().getDrawable(
												R.drawable.yellowstar));
										like2.setImageDrawable(getResources().getDrawable(
												R.drawable.yellowstar));
										like3.setImageDrawable(getResources().getDrawable(
												R.drawable.yellowstar));
										like4.setImageDrawable(getResources()
												.getDrawable(R.drawable.halfstar));
										like5.setImageDrawable(getResources().getDrawable(
												R.drawable.whitestar));
									} else {
										if (Double.parseDouble(like) <= 4.0) {
											...
											like3.setImageDrawable(getResources().getDrawable(
													R.drawable.yellowstar));
											like4.setImageDrawable(getResources().getDrawable(
													R.drawable.yellowstar));
											like5.setImageDrawable(getResources().getDrawable(
													R.drawable.whitestar));
										} else {
	...
	public static void cancleAllRequest() {
		...
		HttpRequestClient.cancelRequest(TongGouApplication.getInstance(), true);
	}
