...
public class TongGouService extends BaseConnectOBDService {
	...
	public static String TONGGOU_ACTION_READ_CURRENT_CONDITION = "com.tonggou.action.readconditon";
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////
		...
		private synchronized void startConnectOBDTimer(){
			...
			connectOBDTimer.schedule(connectOBDTask,0,15000);
			}catch(Exception ex){}
		}
	...
	private void notice(String newMesContent,String message){
		...
		android.app.Notification nf = new android.app.Notification(R.drawable.icon , "行车一键通新消息"/*小标题*/,System.currentTimeMillis());
