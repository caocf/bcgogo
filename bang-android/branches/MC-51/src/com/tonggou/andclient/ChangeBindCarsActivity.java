...
//	private EditText mEngineNoEdit, mVehicleVinEdit, mRegistNoEdit;
...
//		mEngineNoEdit = (EditText) findViewById(R.id.bindcar_engine_no);
//		mVehicleVinEdit = (EditText) findViewById(R.id.bindcar_vehicle_vin_no);
//		mRegistNoEdit = (EditText) findViewById(R.id.bindcar_regist_no);
...
//				mEngineNo = mEngineNoEdit.getText().toString();
//				obdVin = mVehicleVinEdit.getText().toString();
//				mRegistNo = mRegistNoEdit.getText().toString();
