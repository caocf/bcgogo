...
public class SettingActivity extends BaseActivity {
	...
	private View data,voice,bindcar,feedback,version,aboutus,bindingOBD;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		isCheck=getSharedPreferences(BaseActivity.SETTING_INFOS, 0).getString(BaseActivity.CHECKVOICE, null);
		setContentView(R.layout.set);

		data=findViewById(R.id.data);
		((TextView)data.findViewById(R.id.set_tv)).setText(getString(R.string.set_data));
		((ImageView)data.findViewById(R.id.set_iv)).setImageDrawable(getResources().getDrawable(R.drawable.setdata));
		...
		((ImageView)voice.findViewById(R.id.set_iv)).setImageDrawable(getResources().getDrawable(R.drawable.setvoice));
		...
		((ImageView)bindcar.findViewById(R.id.set_iv)).setImageDrawable(getResources().getDrawable(R.drawable.setbindcar));
		...
		((ImageView)feedback.findViewById(R.id.set_iv)).setImageDrawable(getResources().getDrawable(R.drawable.setfeedback));
		...
		((ImageView)version.findViewById(R.id.set_iv)).setImageDrawable(getResources().getDrawable(R.drawable.setversion));
		...
		((ImageView)aboutus.findViewById(R.id.set_iv)).setImageDrawable(getResources().getDrawable(R.drawable.setaboutus));
		aboutus.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				//Intent intent = new Intent(SettingActivity.this,AboutUsActivity.class);
				Intent intent = new Intent(SettingActivity.this,SetOBDShowInfoActivity1.class);
				startActivity(intent);
			}
		});

		bindingOBD = findViewById(R.id.bindingOBD);
		((TextView)bindingOBD.findViewById(R.id.set_tv)).setText(getString(R.string.set_bingingOBD));
		((ImageView)bindingOBD.findViewById(R.id.set_iv)).setImageDrawable(getResources().getDrawable(R.drawable.setaboutus));
		bindingOBD.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(SettingActivity.this,ConnectOBDActivity_Setting.class);
		...
		handler = new Handler(){
			...
			public void handleMessage(Message msg){		
				...
				case ALERT_NEW_VERSION: 		
						...
						.setPositiveButton(R.string.exit_submit, new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int whichButton) {										
								...
								if(downUrl==null||"".equals(downUrl)){
									//url错误提示
									Toast.makeText(SettingActivity.this, "url为空", Toast.LENGTH_LONG).show();
								}else{
					...
					}else if(DefaultUpdateCheck.versionAction!=null&&DefaultUpdateCheck.versionAction.getAction()==Version.UPDATE_ACTION_NORMAL){     //提示
						new AlertDialog.Builder(SettingActivity.this)
						.setTitle(getString(R.string.exit_title))
...
//	}
	...
	private void logout(){
		...
		Network.getNetwork(SettingActivity.this).httpPutUpdateString(url,valuePairs.getBytes(),logOutParser);
	}
