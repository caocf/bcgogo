...
//	public static final String QUERY_VEHICLE_INFO_SUGGESTION = BASE_URL + "/vehicle/info/suggestion";
	...
	/** 历史服务查询 */
	public static final String QUERY_SERVICE_ALL_HISTORY_LIST = BASE_URL + "/service/AllHistoryList";
	/** 查询故障码列表 */
	...
	/** 获取店面评价 */
	public static final String SHOP_EVALUATE = BASE_URL+"/shop/guest/comment/list/";
	/** 查询支持的城市 */
	public static final String QUERY_SUPPORT_AREA_LIST = BASE_URL + "/area/list";
	/** 发送多条故障码 */
	public static final String SEND_MULTI_FAULT = BASE_URL + "/vehicle/multiFault";
	/** 查询品牌车型 */
	public static final String QUERY_VEHICLE_BRAND_MODEL = BASE_URL + "/vehicle/brandModel";
