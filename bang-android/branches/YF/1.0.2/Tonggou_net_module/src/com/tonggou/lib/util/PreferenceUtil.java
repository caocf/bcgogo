...
public class PreferenceUtil {
	...
	public static long getLong(Context context, String prefName, String key){
		return key == null ? 0 : getPreference(context, prefName).getLong(key, 0);
	}

	
	/** 
	 * 将长整型数据写入到sharePreferences中
	 * 
	 * @param context 上下文对象,用以取得shardPreferences
	 * @param prefName shardPreferences文件名
	 * @param key 数据的键
	 ...
	 */
	public static SharedPreferences getPreference(Context context, String prefName ){
