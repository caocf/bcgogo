...
//			}
	...
	public static boolean hasUserToken(Context context) {
		return !TextUtils.isEmpty(PreferenceUtil.getString(context, PREF_NAME_COOKIE, PREF_KEY_COOKIE));
	}
	
	public static void removeUserToken(Context context) {
		PreferenceUtil.remove(context, PREF_NAME_COOKIE, PREF_KEY_COOKIE);
	}
