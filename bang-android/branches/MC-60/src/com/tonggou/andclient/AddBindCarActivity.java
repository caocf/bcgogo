...
public class AddBindCarActivity extends BaseActivity implements OnBindOBDListener {
	...
	private void saveCarInfor(String vehicleId, String vehicleVin, String vehicleNo,
		...
		// +"\"vehicleNo\":\""+vehicleNo+"\"," +
		String valuePairs = "{\"vehicleNo\":\"" + vehicleNo.trim() + "\"," + " \"vehicleModel\":\""
				+ vehicleModel + "\",\"vehicleModelId\":\"" + vehicleModelId + "\""
				+ ",\"vehicleBrand\":\"" + vehicleBrand + "\"" + ",\"vehicleBrandId\":\""
				+ vehicleBrandId + "\"" + ",\"nextInsuranceTime\":\"" + nextInsuranceTimeLong
				+ "\"" + ",\"nextExamineTime\":\"" + nextExamineTimeLong + "\"" + current
				+ nextmile + vehiclevin + engineno + registno +
				/* ",\"obdSN\":\""+obdSN+"\"" + */
				",\"userNo\":\"" + userNo + "\"}";
	...
	private void getCarList() {
		...
		nameValuePairs.add(new BasicNameValuePair("platformVersion",
				TongGouApplication.platformVersion));
