...
public class CaptureActivity extends Activity implements Camera.PreviewCallback, ZBarConstants {
	...
	private String fromshopUI;
	private TextView skip;
	AlertDialog showshop;
	static {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		skip = (TextView) findViewById(R.id.regiest_to_next);
		fromshopUI = getIntent().getStringExtra("fromshopUI");

		if(fromshopUI != null && "register".equals(fromshopUI)){
			skip.setVisibility(View.VISIBLE);
			skip.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					Intent intent = new Intent(CaptureActivity.this,RegisterActivityNext.class);
					...
					public void run(){
						...
						for (Symbol sym : syms) {
							try {
								...
								/*showshop= new AlertDialog.Builder(CaptureActivity.this).create();
								showshop.setView((CaptureActivity.this).getLayoutInflater().inflate(R.layout.searchpasswordback, null));
								showshop.show();			
								...
								Window window = showshop.getWindow();
								...
								searchpasswordEdit.setText(strName);
								TextView searchpassword=(TextView) window.findViewById(R.id.searchpasswordok);*/
								if(fromshopUI != null && "register".equals(fromshopUI)){
									Intent intent = new Intent();
									intent.setClass(CaptureActivity.this, RegisterShop2DActivity.class);
