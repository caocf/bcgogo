...
public class RegisterActivityNext  extends BaseActivity {
	...
	private String name,password,phonenumber,carnum,scanshop,strName,strId;//,nickname
...
//		registermanStr=null;
		...
		carNum = setSharedpre1.getString("tonggou.carNum", "");
		password = setSharedpre1.getString("tonggou.password", "");
		name = setSharedpre1.getString("tonggou.name", "");
		phonenumber = setSharedpre1.getString("tonggou.phonenumber", "");
		
		strName = getIntent().getStringExtra("shop2DName");
		strId = getIntent().getStringExtra("shop2DId");
		Toast.makeText(RegisterActivityNext.this, strName+" "+strId, Toast.LENGTH_LONG).show();
