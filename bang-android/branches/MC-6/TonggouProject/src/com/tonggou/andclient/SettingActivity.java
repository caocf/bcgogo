...
public class SettingActivity extends BaseActivity {
	...
	private View data,voice,bindcar,feedback,version,aboutus,bingshop;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bingshop = findViewById(R.id.bindingShop);
		((TextView)bingshop.findViewById(R.id.set_tv)).setText(getString(R.string.set_bindShop));
		((ImageView)bingshop.findViewById(R.id.set_iv)).setImageDrawable(getResources().getDrawable(R.drawable.registerscanicon));
       bingshop.setOnClickListener(new OnClickListener(){
		public void onClick(View v) {
			Intent intent = new Intent(SettingActivity.this,BindShopActivity.class);
			startActivity(intent);
