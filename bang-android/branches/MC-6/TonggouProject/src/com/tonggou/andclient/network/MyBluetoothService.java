...
import com.tonggou.andclient.BaseConnectOBDActivity;
...
//        boolean b = device.fetchUuidsWithSdp();
    ...
    public synchronized void beginReadAndWrite(BluetoothSocket socket, BluetoothDevice device) {
        ...
        bundle.putString(BaseConnectOBDActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BaseConnectOBDActivity.TOAST, "无法连接设备");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BaseConnectOBDActivity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
