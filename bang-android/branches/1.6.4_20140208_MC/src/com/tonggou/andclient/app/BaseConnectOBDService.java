...
//	private ArrayList<BluetoothDevice>  devices;
    ...
    private MediaPlayer mediaPlayer,disconnectmediaPlayer;
	...
	public void onCreate() {		
		...
		mediaPlayer = MediaPlayer.create(this,R.raw.lianjie);
		mediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC); 
		
		disconnectmediaPlayer = new MediaPlayer();
		disconnectmediaPlayer = MediaPlayer.create(this,R.raw.duankai);
