...
//	private ProgressBar progressBar;
	...
	protected void afterTitleBarCreated(SimpleTitleBar titleBar, Bundle savedInstanceState) {
		...
		String rightSecondButtonText = TongGouApplication.getInstance().isLogin() ? "更多" : "刷新";
		titleBar.setRightSecondButton(rightSecondButtonText, android.R.color.transparent);
...
//			cityCode = "NULL";
//		}
//		String url = INFO.HTTP_HEAD+INFO.HOST_IP+"/shop/searchList/"+mCoordinateType+"/"+coordinate+"/serviceScopeIds/"+serviceScope+"/sortType/"+sortType+"/areaId/"+areadid+"/cityCode/"+cityCode+"/shopType/"+shopType+"/keywords/NULL/pageNo/"+pageNo+"/pageSize/"+pageSize;
...
//		if (!nextPageNetworking(serviceScopeIds,areaId,keyWord,pageNo,+"")) {
//
//			pageNo--;
//			nextPageLock = false;
//		} else {
