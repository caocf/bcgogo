    ...
    private class RefreshTask extends TimerTask{
   	 	public void run(){  	
	   	 	MainActivity.this.runOnUiThread(new Runnable(){
				  public void run() {
					  TongGouApplication.showLog("TongGouApplication.connetedOBD " + TongGouApplication.connetedOBD);
					  TongGouApplication.showLog("d--> " + defaultBrandAndModle);
					  TongGouApplication.showLog(" Tongg -- mainActivityCarInfo " + TongGouApplication.mainActivityDefaultCarInfo);
					  if(TongGouApplication.connetedOBD){
						  if(haveFaultCode){
