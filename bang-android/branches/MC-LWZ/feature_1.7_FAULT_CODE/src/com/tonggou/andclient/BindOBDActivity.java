...
public class BindOBDActivity extends BaseActivity {
	...
	private void onBindingSuccess(final String vehicleModelId) {
		UpdateFaultDic.getUpdateFaultDic(TongGouApplication.getInstance()).updateFaultDic(vehicleModelId);
		...
		TongGouApplication.getInstance().queryVehicleList(BindOBDActivity.this);
		finish();
	}
