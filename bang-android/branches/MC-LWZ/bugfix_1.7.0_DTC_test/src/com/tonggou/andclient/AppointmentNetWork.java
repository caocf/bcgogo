...
public class AppointmentNetWork extends BaseActivity{
	...
	private void doAppointment(String serviceCategoryId,String appointTime,String mobile,String contact,
		...
		String vehicleId = TongGouApplication.getInstance().getDefaultVehicle().getVehicleId();
		List<Map<String, String>> faultInfoItems = 
				SaveDB.getSaveDB(this).getFaultInfoItems(userNo, vehicleId);
