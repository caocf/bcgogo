...
public class GasStationMapActivity extends GasStationBaseActivity {
	...
	private class GasStationsTask extends AsyncTask<LocationData, Void, ArrayList<GasStation>> {
		@Override
		protected ArrayList<GasStation> doInBackground(LocationData... params) {
			...
			while (true) {
				...
				int page = i++;
				try {
					ArrayList<GasStation> gasStations = dataManager.getGasStations(baseUri, page);
	...
	private GeoPoint prepareToShowPopupOverlay(GasStation gasStation, boolean isDest) {
