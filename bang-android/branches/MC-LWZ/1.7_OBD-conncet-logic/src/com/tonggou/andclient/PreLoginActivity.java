...
public class PreLoginActivity extends BaseActivity {
	...
	private void autoLogin() {
		boolean isUserLogined = PreferenceUtil.getBoolean(this, BaseActivity.SETTING_INFOS, BaseActivity.LOGINED);
		
		if( !isUserLogined || TextUtils.isEmpty(currentUsername) || TextUtils.isEmpty(currentPwd) ) {
