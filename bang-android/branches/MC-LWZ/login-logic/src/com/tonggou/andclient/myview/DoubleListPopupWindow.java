...
//		mLeftListView.setEmptyView(contentView.findViewById(R.id.left_loading_indicator));
//		mRightListView.setEmptyView(contentView.findViewById(R.id.right_loading_indicator));
