...
public class UpdateFaultDic {
	...
	public void updateFaultDic(final String modleId){
		...
		request.doRequest(TongGouApplication.getInstance(), new AsyncJsonBaseResponseParseHandler<FaultDicResponse>() {

			@Override
			public void onParseSuccess(FaultDicResponse result, String originResult) {
