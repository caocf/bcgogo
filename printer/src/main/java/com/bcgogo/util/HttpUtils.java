...
public class HttpUtils {
   ...
   * @throws IOException
   */
  public static HttpResponse sendPost(String toUrl, Map<String, String> params,
                                      Map<String, String> propertys) throws IOException {
...
//            if(conn!=null) conn.
  ...
  private static HttpResponse send(String urlString, String method,
    ...
    if (method.equalsIgnoreCase("POST") && parameters != null) {
      ...
      urlConnection.getOutputStream().write(param.toString().getBytes(getCharsetName()));
      urlConnection.getOutputStream().flush();
      urlConnection.getOutputStream().close();
    }
  ...
  private static HttpResponse getContent(String urlString, HttpURLConnection urlConnection) throws IOException {
    ...
    try {
      ...
      LOG.info("http request back,response is {}", httpResponse.getContent());
      return httpResponse;
    } catch (IOException e) {
      throw e;
    } finally {
