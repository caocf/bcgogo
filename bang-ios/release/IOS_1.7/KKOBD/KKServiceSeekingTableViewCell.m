...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(98, height, 200, 15)];
        ...
        _timelabel = [[UILabel alloc] initWithFrame:CGRectMake(100, height, 200, 10)];
        ...
        _rightArrowImv = [[UIImageView alloc] initWithFrame:CGRectMake(300, 0.5*(95 - image.size.height), image.size.width, image.size.height)];
...
- (void)setCellContent:(KKModelserviceDetail *)obj
{
    ...
    _mark2Label.text = obj.orderType;
