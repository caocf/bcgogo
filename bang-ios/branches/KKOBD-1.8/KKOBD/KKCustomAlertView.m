...
{
    [self showInView:nil textAlignment:textAlignment];
}

- (void)showInView:(UIView *)superView textAlignment:(NSTextAlignment)textAlignment
...
{
    [self showInView:superView textAlignment:NSTextAlignmentCenter];
}
