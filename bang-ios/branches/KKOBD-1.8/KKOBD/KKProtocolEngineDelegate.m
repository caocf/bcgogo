...
+ (SEL) getResponseSEL:(NSInteger)aPtlApiId
{
	...
	switch (aPtlApiId) {
        ...
        case ePtlApi_vehicle_faultCodeList:
            sel = @selector(vehicleFaultCodeListResponse:withObject:);
            break;
        case ePtlApi_vehicle_faultCodeOperate:
            sel = @selector(vehicleFaultCodeOperateResponse:withObject:);
            break;
        ...
        case ePtlApi_shop_commentList:
            sel = @selector(shopCommentListResponse:withObject:);
            break;
        ...
        case ePtlApi_driveRecord_upload:
            sel = @selector(driveRecord_Upload:withObject:);
            break;
            
        case ePtlApi_appUserConfig_update:
            sel = @selector(updateAppUserConfigResponse:withObject:);
            break;
		default:
			break;
	}
