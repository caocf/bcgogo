...
#pragma mark - 行程统计
@interface TGModelDriveStatisticRsp : TGComplexObject
@property (nonatomic, strong) NSMutableArray *TGArrayFieldName(monthStats, TGModelDriveStatisticInfo);
@property (nonatomic, strong) TGModelDriveStatisticInfo *yearStat;
@end
