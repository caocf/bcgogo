...
@interface TGVehicleManageViewController : TGBaseViewController <UITextFieldDelegate, TGCustomDataPickerDelegate, TGCustomPickerViewDelegate, TGPassEditVehicleNoProtocol>
