...
- (void)initialize
{
    ...
    self.paneViewControllerTitles = @{
                                      ...
                                      @(TGPaneViewControllerTypeDataStatistic)      : @"数据统计"
                                      };
    ...
    self.paneViewControllerClasses = @{
                                       ...
                                       @(TGPaneViewControllerTypeDataStatistic)     : [TGDataStatisticViewController class]
                                    };
    self.paneViewControllerIcons = @{
                                     ...
                                     @(TGPaneViewControllerTypeDataStatistic)       : [UIImage imageNamed:@"icon_tongji.png"]
                                     };
