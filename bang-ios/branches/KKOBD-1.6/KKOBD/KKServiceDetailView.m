...
-(void) setTitleName:(NSString *)aName;
@end
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _contentLb = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 206, frame.size.height)];
        ...
        _contentLb.layer.borderColor = [UIColor blackColor].CGColor;
        _contentLb.layer.borderWidth = 1;
...
//        [_repairTypeLb release];
        ...
        _costLb = [[UILabel alloc] initWithFrame:CGRectMake(205, 0, 60, frame.size.height)];
        _costLb.backgroundColor = [UIColor clearColor];
        _costLb.textColor = [UIColor blackColor];
        _costLb.textAlignment = UITextAlignmentCenter;
        _costLb.layer.borderColor = [UIColor blackColor].CGColor;
        _costLb.layer.borderWidth = 1;
...
{
    _contentLb.text = [NSString stringWithFormat:@" %@",obj.content];
...
-(void) setTitleName:(NSString *)aName
{
    _contentLb.text = aName;
    _contentLb.textAlignment = UITextAlignmentCenter;
    
    _costLb.text = @"金额";
    
    _contentLb.textColor = _costLb.textColor = [UIColor whiteColor];
    self.backgroundColor = KKCOLOR_3359ac;
}
...
- (void)initial
{
    ...
    if ([_content.orderItems__KKModelOrderItem count] > 0)
    {
        ...
        for (int i = 0; i < [_content.orderItems__KKModelOrderItem count]; i++) {
            KKModelOrderItem *item = _content.orderItems__KKModelOrderItem[i];
            if([item.type isEqualToString:@"服务内容"])
            {
                [serviceItems addObject:item];
            }
            else if([item.type isEqualToString:@"商品"])
            {
                [goodsItems addObject:item];
            }
            else if([item.type isEqualToString:@"其他"])
            {
        ...
        {
            KKRepairDetailView *detailView = [[KKRepairDetailView alloc] initWithFrame:CGRectMake(20, _height, _maxSize.width - 35, 16)];
            [detailView setTitleName:@"服务内容"];
            [bgImv addSubview:detailView];
            [detailView release];
            _height += 15;
            for(KKModelOrderItem *item in serviceItems)
            {
                KKRepairDetailView *detailView = [[KKRepairDetailView alloc] initWithFrame:CGRectMake(20, _height, _maxSize.width - 35, 16)];
                [detailView setContent:item];
                [bgImv addSubview:detailView];
                [detailView release];
        ...
        {
            KKRepairDetailView *detailView = [[KKRepairDetailView alloc] initWithFrame:CGRectMake(20, _height, _maxSize.width - 35, 16)];
            [detailView setTitleName:@"商品"];
            [bgImv addSubview:detailView];
            [detailView release];
            _height += 15;
            for(KKModelOrderItem *item in goodsItems)
            {
                KKRepairDetailView *detailView = [[KKRepairDetailView alloc] initWithFrame:CGRectMake(20, _height, _maxSize.width - 35, 16)];
                [detailView setContent:item];
                [bgImv addSubview:detailView];
        ...
        {
            KKRepairDetailView *detailView = [[KKRepairDetailView alloc] initWithFrame:CGRectMake(20, _height, _maxSize.width - 35, 16)];
            [detailView setTitleName:@"其他"];
            [bgImv addSubview:detailView];
            [detailView release];
            _height += 15;
            for(KKModelOrderItem *item in otherItems)
            {
                KKRepairDetailView *detailView = [[KKRepairDetailView alloc] initWithFrame:CGRectMake(20, _height, _maxSize.width - 35, 16)];
                [detailView setContent:item];
                [bgImv addSubview:detailView];
