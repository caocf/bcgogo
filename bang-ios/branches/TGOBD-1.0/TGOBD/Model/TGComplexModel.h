...
#pragma mark - 违章查询
@interface TGModelViolateCityListRsp : TGComplexObject
@property (nonatomic, strong) NSMutableArray *TGArrayFieldName(result,TGModelViolateCityInfo);
@end

@interface TGModelViolateResultRsp : TGComplexObject
@property(nonatomic, copy) NSString *resultcode;
@property(nonatomic, copy) NSString *reason;
@property(nonatomic, strong) TGModelViolateResultInfo *result;
@end

@interface TGModelViolateVehicleTypeRsp : TGComplexObject
@property (nonatomic, strong) NSMutableArray *TGArrayFieldName(result,TGModelViolateVehicleType);
@end
