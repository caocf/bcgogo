...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _endAddressLabel = [[UILabel alloc] initWithFrame:CGRectMake(68, 2, 228, 21)];
        ...
        _startAddressLabel = [[UILabel alloc] initWithFrame:CGRectMake(68, 96, 228, 21)];
...
-(void) refreshUIWithDriveRecordDetail:(TGModelDriveRecordDetail *)aDetail selected:(BOOL)selected
{   
