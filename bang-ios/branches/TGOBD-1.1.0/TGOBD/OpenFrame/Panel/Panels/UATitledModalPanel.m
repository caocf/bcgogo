...
//        UIImageView *bgImgView = [[UIImageView alloc] initWithFrame:self.roundedRect.bounds];
//        bgImgView.image = [UIImage imageNamed:@"bg_knowledge.png"];
//        [self.roundedRect addSubview:bgImgView];
//        [bgImgView release];
//        [self.roundedRect sendSubviewToBack:bgImgView];
