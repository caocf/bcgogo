...
@protocol SDWebImageDownloadDelegate
@optional
- (void)SDWebimageDidFinished:(UIImageView*)imageView;
- (void)SDWebimageDidError:(UIImageView*)imageView;
...
/**
 * Set a SDWebImageDownloadDelegate instance to manage the download progress
 */
