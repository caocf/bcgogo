...
{
    [self stopAutoConnectTimer];
    if(self.currentVehicle.obdSN == nil)
    {
        [self.bleEngine stopScan];
...
//            self
//        }
//        else if(![self.currentConnectedPeripheral.systemId isEqualToString:self.currentVehicle.obdSN])
//        {
//            [self loopConnect];
//        }
//    }
...
//        for(KKModelVehicleDetailInfo *dInfo in self.vehicleList)
//        {
//            if([dInfo.vehicleVin isEqualToString:vin])
//            {
//                [self setCurrentVehicleInfo:dInfo];
//            }
//        }
    }
    //接口已废弃
