...
- (void) initComponents
{
    ...
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 33, 320, currentScreenHeight - 33 - 44 - 49 - [self getOrignY]) style:UITableViewStylePlain];
        ...
        switch (index) {
            ...
            case 1:
            {
                ...
                [rsp.result.data__KKModelOilStation sortUsingComparator:^NSComparisonResult(id obj1, id obj2) {
                    KKModelOilStation *station1 = (KKModelOilStation *)obj1;
                    KKModelOilStation *station2 = (KKModelOilStation *)obj2;
                    float price1 = [station1.E93 floatValue];
                    float price2 = [station2.E93 floatValue];;
                    if(price1 < price2)
                    {
                        return NSOrderedAscending;
                    }
