...
- (void) initVariables
{
    _icons = [[NSMutableArray alloc] initWithObjects:[UIImage imageNamed:@"icon_setting_1.png"],
                                                     ...
                                                     [UIImage imageNamed:@"icon_setting_6.png"],nil];
    _names = [[NSMutableArray alloc] initWithObjects:@"个人资料",@"消息提示音",@"车辆管理",@"用户反馈",@"版本检测",@"关于我们",nil];
...
- (void) initComponents
{
    ...
    UIImageView *bgImv = [[UIImageView alloc] initWithFrame:CGRectMake(0, 5, image.size.width, image.size.height)];
    ...
    image = [UIImage imageNamed:@"icon_setting_logOff.png"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (index) {
        ...
        case 4:
        {
            ...
            [[KKProtocolEngine sharedPtlEngine] newVersion:CurrentSystemPlatform appVersion:KK_Version platformVersion:CurrentSystemVersion mobileModel:[KKHelper platformString] delegate:self];
