...
- (void)dealloc
{
    self.defaultOilPrice = nil;
    self.defaultOilKind = nil;
...
{
    self.shop = nil;
    self.appShopCommentDTOs__KKModelComment = nil;
...
@implementation KKModelShopCommentRsp

-(void) dealloc
{
    self.results__KKModelComment = nil;
    self.pager = nil;
    [super dealloc];
}
...
@implementation BGDriveRecordUploadRsp
...
//故障码
@implementation KKFaultCodeListRsp

-(void) dealloc
{
    self.result__KKModelFaultCodeGetInfo = nil;
    self.pager = nil;
    [super dealloc];
}
