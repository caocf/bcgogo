...
@property (nonatomic, retain) KKModelAppUserConfig *appUserConfig;
...
@property (nonatomic, copy) NSString *defaultOilPrice;
@property (nonatomic, copy) NSString *defaultOilKind;
...
@property (nonatomic, retain) NSMutableArray *KKArrayFieldName(appShopCommentDTOs, KKModelComment);

@end

@interface KKModelShopCommentRsp : KKModelProtocolRsp

@property (nonatomic, retain) NSMutableArray *KKArrayFieldName(results,KKModelComment);
@property (nonatomic, retain) KKModelPagerInfo *pager;
...
//故障码
@interface KKFaultCodeListRsp : KKModelProtocolRsp
@property(nonatomic, retain) NSMutableArray *KKArrayFieldName(result,KKModelFaultCodeGetInfo);
@property(nonatomic, retain) KKModelPagerInfo *pager;
@end