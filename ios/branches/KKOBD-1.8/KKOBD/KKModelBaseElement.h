...
// app端用户配置信息
// ================================================================================================
@interface KKModelAppUserConfig : KKModelObject
@property(nonatomic, copy) NSString     *first_drive_log_time;      //第一条行车日志的记录时间
@property(nonatomic, copy) NSString     *oil_price;      //油价
@property(nonatomic, copy) NSString     *oil_kind;       //油品
@end
...
//获取故障码列表时使用
@interface KKModelFaultCodeGetInfo : KKModelObject
@property(nonatomic, assign) long long id;
@property(nonatomic, copy) NSString *errorCode;
@property(nonatomic, copy) NSString *content;
@property(nonatomic, copy) NSString *status;
@property(nonatomic, copy) NSString *statusStr;
@property(nonatomic, copy) NSString *lastOperateTime;
...
@interface KKModelOilPrice : KKModelObject
...
@property (nonatomic, retain) KKModelOilPrice *price;
@property (nonatomic, retain) NSMutableDictionary *gastprice;
...
//行车日志
typedef enum{
    DriveRecordState_UnUploaded = 0,
    DriveRecordState_Uploaded,
    DriveRecordState_Incomplete             //数据不完整，此值只能为2，不能变更，因为数据库中有触发器
//    DriveRecordState_Start,
//    DriveRecordState_End,
//    DriveRecordState_Deleted
}DriveRecordState;

@interface BGDriveRecordDetail: KKModelObject
@property(nonatomic, assign) long long  id;
@property(nonatomic, copy) NSString *appDriveLogId;
...
@property(nonatomic, assign) CGFloat oilWear;               //百公里油耗
...
@property(nonatomic, copy) NSString *status;
@property(nonatomic, assign) DriveRecordState state;
@end
...
@interface BGDriveRecordPoint : KKModelObject
