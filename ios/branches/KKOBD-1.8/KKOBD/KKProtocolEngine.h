...
typedef enum {
    ...
    ePtlApi_vehicle_saveList,                   // 保存车辆列表
    ...
    ePtlApi_vehicle_faultCodeList,              // 获取故障码列表
    ePtlApi_vehicle_faultCodeOperate,           // 操作故障码
    ePtlApi_vehicle_multiFault,                 // 离线模式发送故障信息
    ...
    ePtlApi_shop_commentList,                   // 店铺评价列表
    ...
    ePtlApi_driveRecord_upload,                 //上传行车日志
    
    ePtlApi_appUserConfig_update,               //用户配置数据修改
    
    ePtlApiNotSupport  = 1000,
    
    ePtlApi_LoadCache = 1999,              //读取缓存
}_KKProtocolApiId;
...
@property (nonatomic, readonly) uint32_t currentNetworkStatus;      //当前网络状态
