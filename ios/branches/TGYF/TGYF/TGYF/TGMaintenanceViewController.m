...
#import "TGMaintenanceTableViewCell.h"

@interface TGMaintenanceViewController ()<UITableViewDataSource, UITableViewDelegate, EGORefreshTableHeaderDelegate>
...
@implementation TGMaintenanceViewController
...
{
    static NSString *identify = @"maintenanceCell";
    
    TGMaintenanceTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identify];
    
    if (cell == nil) {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"TGMaintenanceTableViewCell" owner:nil options:nil];
