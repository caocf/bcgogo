...
- (UIButton *)buttonForItemIndex:(NSUInteger)index
{
	...
	switch (item.type) {
		...
		case SIAlertViewButtonTypeDestructive:
			normalImage = [UIImage imageNamed:@"btn_orange_alert.png"];
			highlightedImage = [UIImage imageNamed:@"btn_orange_alert.png"];
		...
		default:
			normalImage = [UIImage imageNamed:@"btn_blue.png"];
			highlightedImage = [UIImage imageNamed:@"btn_blue.png"];
