...
@interface TGOrderViewController ()<UITableViewDataSource, UITableViewDelegate, EGORefreshTableHeaderDelegate>
...
@implementation TGOrderViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TGOrderTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identify];
    
    if (cell == nil) {
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"TGOrderTableViewCell" owner:nil options:nil];
