...
WithRightInsetWidth:(CGFloat)inset
{
    _bgImgType = bgImgType;
    return [self initWithFrame:frame WithType:type WithPlaceholder:placeholder WithImage:image WithRightInsetWidth:inset];
}
...
- (void)initial
{
    ...
    _bgImv.image = [(_bgImgType == 0) ? [UIImage imageNamed:@"form_white.png"] : [UIImage imageNamed:@"form_gray.png"] stretchableImageWithLeftCapWidth:0 topCapHeight:0];
