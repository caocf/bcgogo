...
{
    _drivingMileageLabel.text = [NSString stringWithFormat:@"%.1fKM",aRecordDetail.distance];
    _oilWearLabel.text = [NSString stringWithFormat:@"%.1fL",aRecordDetail.oilWear];
...
{
    _drivingMileageLabel.text = [NSString stringWithFormat:@"%.1fKM",aDistance];
    _oilWearLabel.text = [NSString stringWithFormat:@"%.1fL",aOilWear];
    _oilCostsLabel.text = [NSString stringWithFormat:@"%.0f元",aOilCosts];
    _drivingTimeLabel.text = [self getTimeString:aDrivedTime];
}
