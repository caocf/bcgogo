...
static const NSTimeInterval KKDefaultProtocolTimeoutSeconds = 20;
...
static const KKPtlApiDictionary k_KKPtlApiDict[] = {
    ...
    { @"%@/api/shop/suggestions",                   ePtlApi_shop_suggestionsByKey },         // 根据店铺ID获取店铺详情
...
//        domain = [[NSString alloc] initWithString:@"http://192.168.3.42:8080"];
		domain = [[NSString alloc] initWithString:@"https://phone.bcgogo.cn"];
    }
	else {
