...
typedef NS_ENUM(NSInteger, TGHTTPRequest_ApiID){
    ...
    apiID_get_advertList,                       //获取所有的公告
    apiID_get_advert_detail,                    //获取公告详情
    
    apiID_get_driveStat,                        //获取行程统计
};
...
- (void)userRegister:(NSString *)mobile
            password:(NSString *)password
                imei:(NSString *)imei
           vehicleNo:(NSString *)vehicleNo
            oilPrice:(NSString *)oilPrice
      currentMileage:(NSString *)currentMileage
      maintainPeriod:(NSString *)maintainPeriod
        juheCityCode:(NSString *)juheCityCode
        juheCityName:(NSString *)juheCityName
          registerNo:(NSString *)registerNo
 ...
 *  @param pageSize    分页大小
 */
- (void)getAdvertList:(NSInteger)pageNo pageSize:(NSInteger)pageSize viewControllerIdentifier:(id)aIdentifier success:(void (^)(AFHTTPRequestOperation *operation, id responseObject))aSuccess failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))aFailure;
/**
 *  获取公告详情
 *
 *  @param advertId    公告id
 */
- (void)getAdvertDetail:(long long)advertId viewControllerIdentifier:(id)aIdentifier success:(void (^)(AFHTTPRequestOperation *operation, id responseObject))aSuccess failure:(void (^)(AFHTTPRequestOperation *operation, NSError *error))aFailure;
