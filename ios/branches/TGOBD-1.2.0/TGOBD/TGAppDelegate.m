...
{
    NSString *myDeviceToken = [[[deviceToken description] stringByTrimmingCharactersInSet:[NSCharacterSet characterSetWithCharactersInString:@"<>"]] stringByReplacingOccurrencesOfString:@" " withString:@""];
    TGLog(@"successfully RegisterForRemoteNotificationsWithDeviceToken --------- %@",myDeviceToken);
    [[NSUserDefaults standardUserDefaults] setObject:myDeviceToken forKey:@"deviceToken"];
}

- (void)application:(UIApplication *)application didFailToRegisterForRemoteNotificationsWithError:(NSError *)error
{
    TGLog(@"fail to registerForRemoteNotificationsWithError-----%@",[error localizedDescription]);
}
