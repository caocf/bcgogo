...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat width = rect.size.width - WIDTH_TITLE;
...
//    CGContextStrokePath(context);
    ...
    for(TGChartItem *item in self.chartItems)
    {
        rangeRect = CGRectMake(0, heightDelta*(i+1)+itemHeight*i, ((item.value/maxValue)*width), itemHeight);
        ...
        valueRect = CGRectMake(10, titleRect.origin.y, WIDTH_TITLE, HEIGTH_TITLE);
