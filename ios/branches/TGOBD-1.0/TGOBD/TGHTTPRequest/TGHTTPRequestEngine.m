...
static const TGApiIDDictItem apiIDDictionary[] = {
    ...
    {apiID_violate_getCityList,         @"%@/violateRegulations/juhe/area/list"},
...
- (void)userRegister:(NSString *)mobile password:(NSString *)password imei:(NSString *)imei oilPrice:(NSString *)oilPrice currentMileage:(NSString *)currentMileage maintainPeriod:(NSString *)maintainPeriod lastMaintainMileage:(NSString *)lastMaintainMileage nextMaintainTime:(long long)nextMaintainTime nextExamineTime:(long long)nextExamineTime loginInfo:(TGModelLoginInfo *)loginInfo viewControllerIdentifier:(id)aIdentifier success:(void (^)(AFHTTPRequestOperation *, id))aSuccess failure:(void (^)(AFHTTPRequestOperation *, NSError *))aFailure
{
    NSMutableDictionary *params = [[NSMutableDictionary alloc] init];
...
- (void)violateJuheQuery:(NSString *)aVehicleNo veNoType:(NSString *)aVeNoType city:(NSString *)aCity engineNo:(NSString *)aEngineNo classNo:(NSString *)aClassNo registNo:(NSString *)aRegistNo viewControllerIdentifier:(id)aIdentifier success:(void (^)(AFHTTPRequestOperation *, id))aSuccess failure:(void (^)(AFHTTPRequestOperation *, NSError *))aFailure
{
    ...
    TGSetParamString(params, @"key", @"60ad2a9b3c7bcda13b781dabe01fe843", NO);
    TGSetParamString(params, @"dtype", @"json", NO);
    TGSetParamString(params, @"city", aCity, NO);
    TGSetParamString(params, @"hphm", aVehicleNo, NO);
    TGSetParamString(params, @"hpzl", aVeNoType, NO);
    
    if(aEngineNo && ![aEngineNo isEqualToString:@""])
    {
        TGSetParamString(params, @"engineno", aEngineNo, NO);
    }
    if(aClassNo && ![aClassNo isEqualToString:@""])
    {
        TGSetParamString(params, @"classno", aClassNo, NO);
    }
    if(aRegistNo && ![aRegistNo isEqualToString:@""])
    {
        TGSetParamString(params, @"registno", aClassNo, NO);
    }

    [self POST:apiID_violate_juheQuery parameters:params viewControllerIdentifier:aIdentifier success:aSuccess failure:aFailure];
}
...
- (void)updateVehicleInfo:(NSString *)oilPrice currentMileage:(NSString *)currentMileage maintainPeriod:(NSString *)maintainPeriod lastMaintainMileage:(NSString *)lastMaintainMileage nextMaintainTime:(long long)nextMaintainTime nextExamineTime:(long long)nextExamineTime viewControllerIdentifier:(id)aIdentifier success:(void (^)(AFHTTPRequestOperation *, id))aSuccess failure:(void (^)(AFHTTPRequestOperation *, NSError *))aFailure
{
    NSMutableDictionary *params = [[NSMutableDictionary alloc] init];
