...
@property (nonatomic, assign) DateSelectType        dateSelectType;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.dateStartingTime = [self getDayStartTime:[[NSDate dateWithTimeIntervalSinceNow:-30*24*60*60] timeIntervalSince1970WithMillisecond]];
...
//
//-(NSString *) dateStringOfTime:(NSInteger)aTime
//{
//    
//    NSDate *startDate = [NSDate dateWithTimeIntervalSince1970:aTime];
//    NSDate *endDate = nil;
//    NSDateComponents *startComps = [self.calendar components:CalendarUnit_Date fromDate:startDate];
//    NSDateComponents *endComps = nil;
//    switch (self.dateSelectType) {
//        case DateSelectType_Day:
//        {
...
//        {
//            int startIndexInWeek = [self.calendar ordinalityOfUnit:NSDayCalendarUnit inUnit:NSWeekCalendarUnit forDate:startDate];
//            endDate = [NSDate dateWithTimeInterval:(8-startIndexInWeek)*OneDaySeconds-1 sinceDate:startDate];
//            endComps = [self.calendar components:CalendarUnit_DateTime fromDate:startDate];
//            return [NSString stringWithFormat:@"%d-%d-%d | %d-%d-%d",startComps.year,startComps.month,startComps.day,endComps.year,endComps.month,endComps.day];
//        }
//            break;
//        case DateSelectType_Month:
//        {
//            return [NSString stringWithFormat:@"%d-%d-%d | %d-%d-%d",startComps.year,startComps.month,startComps.day,startComps.year,startComps.month,startComps.day];
//        }
//            break;
//    }
//}
