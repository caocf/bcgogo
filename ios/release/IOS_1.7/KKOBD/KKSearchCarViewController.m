...
//    {
//        [_getVinHud hide:NO];
//        [_getVinHud removeFromSuperview];
//        _getVinHud = nil;
//    }
...
-(void) centralManagerDidUpdateState:(CBCentralManagerState)state
{
    switch (state) {
        ...
        case CBCentralManagerStateUnknown:
            ...
            [KKCustomAlertView showAlertViewWithMessage:@"蓝牙状态未知!"];
            return;
        case CBCentralManagerStateUnauthorized:
            [KKCustomAlertView showAlertViewWithMessage:@"未授权使用蓝牙，请在设置中打开!"];
            return;
        case CBCentralManagerStateResetting:
            [KKCustomAlertView showAlertViewWithMessage:@"系统服务连接已断开!"];
            return;
