...
static const NSTimeInterval KKDefaultProtocolTimeoutSeconds = 60;
...
static const KKPtlApiDictionary k_KKPtlApiDict[] = {
    { @"https://%@/api/user/registration",                  ePtlApi_user_register },                 // 用户注册
    { @"https://%@/api/login",                              ePtlApi_user_login },                    // 用户登录
    { @"https://%@/api/obd/binding",                        ePtlApi_obd_bind },                      // OBD绑定
    { @"https://%@/api/user/password",                      ePtlApi_user_password },                 // 找回密码
    { @"https://%@/api/newVersion",                         ePtlApi_new_version },                   // 升级检测
    
    { @"https://%@/api/vehicle/list",                       ePtlApi_vehicle_list},                   // 获取车辆列表
    { @"https://%@/api/vehicle/vehicleInfo",                ePtlApi_vehicle_saveInfo },              // 保存车辆信息
    { @"https://%@/api/vehicle/singleVehicle",              ePtlApi_vehicle_getInfo },               // 获取一辆车信息
    { @"https://%@/api/vehicle/singleVehicle",              ePtlApi_vehicle_delete },                // 删除车辆
    { @"https://%@/api/vehicle/brandModel",                 ePtlApi_vehicle_getModelByKey },         // 根据关键字获取车辆品牌和车型
    { @"https://%@/api/vehicle/fault",                      ePtlApi_vehicle_fault },                 // 发送车辆故障信息
    { @"https://%@/api/vehicle/faultDic",                   ePtlApi_vehicle_faultDic },              // 故障字典信息更新
    { @"https://%@/api/vehicle/condition",                  ePtlApi_vehicle_condition },             // 发送车况信息
    
    { @"https://%@/api/area/list",                          ePtlApi_area_list },                     // 获取地区列表
    { @"https://%@/api/shop/searchList",                    ePtlApi_shop_searchList },               // 查询推荐店铺
    { @"https://%@/api/shop/detail",                        ePtlApi_shop_detail },                   // 根据店铺ID获取店铺详情
    { @"https://%@/api/shop/suggestions",                   ePtlApi_shop_suggestionsByKey },         // 根据店铺ID获取店铺详情
    
    { @"https://%@/api/message/polling",                    ePtlApi_message_polling },               // 消息轮询
    { @"https://%@/api/service/appointment",                ePtlApi_service_appointment },           // 预约服务
    { @"https://%@/api/service/historyList",                ePtlApi_service_historyList },           // 服务历史查询
    { @"https://%@/api/service/historyDetail",              ePtlApi_service_historyDetail },         // 服务历史详情
    { @"https://%@/api/service/singleService",              ePtlApi_service_delete },                // 取消服务
    
    { @"https://%@/api/shop/score",                         ePtlApi_shop_score },                    // 评价店铺
    { @"https://%@/api/user/information",                   ePtlApi_user_information },              // 查看个人资料
    { @"https://%@/api/user/password",                      ePtlApi_user_passwordModify },           // 修改密码
    { @"https://%@/api/user/information",                   ePtlApi_user_informationModify },        // 修改个人资料
    { @"https://%@/api/service/maintain",                   ePtlApi_vehicle_maintainModify },        // 修改保养信息
    { @"https://%@/api/logout",                             ePtlApi_user_logout },                   // 注销
    { @"https://%@/api/user/feedback",                      ePtlApi_user_feedback },                 // 用户反馈
    { @"https://%@/api/serviceCategory/list",               ePtlApi_serviceCategory_list },          // 获取服务范围
    { @"https://%@/api/vehicle/updateDefault",              ePtlApi_vehicle_updateDefault },         // 修改默认车辆
    { @"https://%@/api/vehicle/singleVehicle",              ePtlApi_vehicle_singleVehicle_vehicleVin },   // 根据vehicleVin获取车辆信息
...
+ (NSString *) getKKServerDomain:(BOOL) internal
{
	NSString *domain = nil;
	if (YES == internal) {
...
//        domain = [[NSString alloc] initWithString:@"phone.bcgogo.cn"];
		domain = [[NSString alloc] initWithString:@"shop.bcgogo.com"];
...
- (NSString *) getAccessUrl:(KKProtocolApiId)apiId
{
	NSString *domain = [KKProtocolEngine getKKServerDomain:NO];
	NSInteger index = [KKProtocolEngine indexInApiDictById:apiId];	
	return [[[NSString alloc] initWithFormat:k_KKPtlApiDict[index].strUrl, domain] autorelease];
}
                   ...
                   pageSize:(NSInteger)aPageSize delegate:(id)aDelegate
{
    ...
    KKSetSequenceParamString(seqKeys, params, aCoordinateType, aCoordinate);
