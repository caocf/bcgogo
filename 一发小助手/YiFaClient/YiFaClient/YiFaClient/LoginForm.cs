...
{  
    ...
    public partial class LoginForm : Form
    {
        ...
        {           
            ...
            checkBox3.Checked = bAutoStart; //开机自启动设置
        ...
        private void processLoginSuccess()
        {
            ...
            {
                FileUtils.saveUsers(checkBox3.Checked, Utils.DirectExit()?2:1, !Utils.getCloseWindownotifyflag(), username.Text.Trim(), password.Text.Trim(), checkBox1.Checked ? "true" : "false", checkBox2.Checked ? "true" : "false");
                bool autoStart;
                string lastUserId;
                int closeoption = 1;
                bool nevernotifyclose = false;
        ...
        {
            bool bAutostart = checkBox3.Checked;
            bool bSetSuccess = AutoStartUtil.SetAutoStart(bAutostart, Application.ExecutablePath);
            if (bSetSuccess)
            {
