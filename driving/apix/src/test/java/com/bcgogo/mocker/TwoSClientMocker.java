...
import com.bcgogo.driving.model.GsmPoint;
 ...
 * Time: 下午4:46
 */
public class TwoSClientMocker {
  private static final Logger LOG = LoggerFactory.getLogger(TwoSClientMocker.class);
  ...
  static {
    if (StringUtil.isEmpty(model)) {
      ...
      domain_driving = "http://192.168.1.248:8080";
      imei = "864881020017222";
      imei = "864881023090879";
    } else {
      imei = "864881022129538"; //debe09b5d99b152d7e1de3c8072beda9
  ...
  /**
   ...
   public void uploadGsmVehicleData() throws IOException, InterruptedException {
     ...
     String url_gsm_vehicle_data = domain_driving + "/apix/gsm/tbox/vehicle/data";
