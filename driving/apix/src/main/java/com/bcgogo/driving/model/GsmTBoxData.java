 ...
 * Time: 上午11:18
 */
public class GsmTBoxData extends XLongIdentifier implements Serializable {
  private String id;
  ...
  public void fromDTO(GsmTBoxDataDTO dataDTO) {
    this.setId(dataDTO.getId());
    this.setUuid(dataDTO.getUuid());
    this.setUploadTime(dataDTO.getUploadTime());
    this.setUploadServerTime(dataDTO.getUploadServerTime());
    this.setAppUserNo(dataDTO.getAppUserNo());
    this.setVehicleStatus(dataDTO.getVehicleStatus());
    this.setRdtc(dataDTO.getRdtc());
    this.setDttpe(dataDTO.getDttpe());
    this.setSpwr(dataDTO.getSpwr());
    this.setRpm(dataDTO.getRpm());
    this.setVss(dataDTO.getVss());
    this.setRpf(dataDTO.getRpf());
    this.setThrottle(dataDTO.getThrottle());
    this.setcTemp(dataDTO.getcTemp());
    this.setTrOil(dataDTO.getTrOil());
    this.setaOilWear(dataDTO.getaOilWear());
    this.settMile(dataDTO.getMile());
    this.settOil(dataDTO.gettOil());
    this.settFire(dataDTO.gettFire());
    this.settDsTime(dataDTO.gettDsTime());
    this.settTime(dataDTO.gettTime());
    this.setaSpeed(dataDTO.getaSpeed());
    this.sethMaxRpm(dataDTO.gethMaxRpm());
    this.sethMaxSpeed(dataDTO.gethMaxSpeed());
    this.setRcTime(dataDTO.getRcTime());
    this.setDsTime(dataDTO.getDsTime());
    this.setTravelTime(dataDTO.getTravelTime());
    this.setMile(dataDTO.getMile());
    this.setDsOil(dataDTO.getDsOil());
    this.setOilWear(dataDTO.getOilWear());
    this.setMaxRpm(dataDTO.getMaxRpm());
    this.setMaxSpeed(dataDTO.getMaxSpeed());
    this.setRapAcc(dataDTO.getRapAcc());
    this.setRapDec(dataDTO.getRapDec());
    this.setLon(dataDTO.getLon());
    this.setLonDir(dataDTO.getLonDir());
    this.setLat(dataDTO.getLat());
    this.setLatDir(dataDTO.getLatDir());
    this.setGx(dataDTO.getGx());
    this.setGy(dataDTO.getGy());
    this.setGz(dataDTO.getGz());
  }

  public GsmTBoxDataDTO toDTO() {
    GsmTBoxDataDTO dataDTO = new GsmTBoxDataDTO();
    dataDTO.setId(this.getId());
    dataDTO.setUuid(this.getUuid());
    dataDTO.setUploadTime(this.getUploadTime());
    dataDTO.setUploadServerTime(this.getUploadServerTime());
    dataDTO.setAppUserNo(this.getAppUserNo());
    dataDTO.setVehicleStatus(this.getVehicleStatus());
    dataDTO.setRdtc(this.getRdtc());
    dataDTO.setDttpe(this.getDttpe());
    dataDTO.setSpwr(this.getSpwr());
    dataDTO.setRpm(this.getRpm());
    dataDTO.setVss(this.getVss());
    dataDTO.setRpf(this.getRpf());
    dataDTO.setThrottle(this.getThrottle());
    dataDTO.setcTemp(this.getcTemp());
    dataDTO.setTrOil(this.getTrOil());
    dataDTO.setaOilWear(this.getaOilWear());
    dataDTO.settMile(this.getMile());
    dataDTO.settOil(this.gettOil());
    dataDTO.settFire(this.gettFire());
    dataDTO.settDsTime(this.gettDsTime());
    dataDTO.settTime(this.gettTime());
    dataDTO.setaSpeed(this.getaSpeed());
    dataDTO.sethMaxRpm(this.gethMaxRpm());
    dataDTO.sethMaxSpeed(this.gethMaxSpeed());
    dataDTO.setRcTime(this.getRcTime());
    dataDTO.setDsTime(this.getDsTime());
    dataDTO.setTravelTime(this.getTravelTime());
    dataDTO.setMile(this.getMile());
    dataDTO.setDsOil(this.getDsOil());
    dataDTO.setOilWear(this.getOilWear());
    dataDTO.setMaxRpm(this.getMaxRpm());
    dataDTO.setMaxSpeed(this.getMaxSpeed());
    dataDTO.setRapAcc(this.getRapAcc());
    dataDTO.setRapDec(this.getRapDec());
    dataDTO.setLon(this.getLon());
    dataDTO.setLonDir(this.getLonDir());
    dataDTO.setLat(this.getLat());
    dataDTO.setLatDir(this.getLatDir());
    dataDTO.setGx(this.getGx());
    dataDTO.setGy(this.getGy());
    dataDTO.setGz(this.getGz());
    return dataDTO;
  }
