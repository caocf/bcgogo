  ...
  <script type="text/javascript">
    ...
    $().ready(function(){
        ...
        function printPageContent(templateId){
            ...
            data+="&startPageNo="+$("#currentPagedynamicalAssistantService").val();
            data+="&maxRows=25";
...
<div class="i_main clear">
  <input id="recordType" type="hidden" name="recordType" value="assistantServiceRecord"/>
  ...
  <div class="mainTitles">
    <div class="titleWords">车辆施工业绩</div>
  </div>
  ...
  <div class="cuSearch">
    ...
    <div class="cartBody">
      ...
      <jsp:include page="/common/pageAJAX.jsp">
        ...
        <jsp:param name="dynamical" value="dynamicalAssistantService"></jsp:param>
        <jsp:param name="data"
