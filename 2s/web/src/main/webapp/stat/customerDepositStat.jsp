...
<head>
    ...
    <script type="text/javascript" src="js/customerDepositStat<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript">
        defaultStorage.setItem(storageKey.MenuUid, "WEB.STAT.DEPOSIT_STAT.CUSTOMER");
    </script>
</head>
<body class="bodyMain">
<%@include file="/WEB-INF/views/header_html.jsp" %>
    <jsp:include page="statNavi.jsp">
        <jsp:param name="currPage" value="depositStat"/>
    </jsp:include>
   <%-- <div class="mainTitles">
        <div class="titleWords">应收款统计</div>
    </div>--%>
    <div class="i_main clear">
        <div class="mainTitles">
            <div class="titleWords">预收款统计</div>
            <bcgogo:hasPermission permissions="WEB.STAT.DEPOSIT_STAT.BASE">
                <div class="titleList">
                    <bcgogo:hasPermission permissions="WEB.STAT.DEPOSIT_STAT.CUSTOMER">
                        <a id="payableStatBtn" action-type="menu-click" menu-name=""
                           href="depositOrdersStat.do?method=renderCustomerDepositOrderQueryPage&menu-uid=WEB.STAT.DEPOSIT_STAT.CUSTOMER" class="click"
                           >预收款</a>
                    ...
                    <bcgogo:hasPermission permissions="WEB.STAT.DEPOSIT_STAT.SUPPLIER">
                        <a id="receivableStatBtn" action-type="menu-click" menu-name="" 
                           href="depositOrdersStat.do?method=renderSupplierDepositOrderQueryPage&menu-uid=WEB.STAT.DEPOSIT_STAT.SUPPLIER">预付款</a>
                    </bcgogo:hasPermission>
                </div>
            </bcgogo:hasPermission>
        </div>
        <div class="titBody">
            <div class="lineTitle">预收款统计查询</div>
            <form id="depositStat" name="depositStat" action="depositOrdersStat.do?method=ajaxQueryDepositOrders"
                ...
                <div class="lineBody bodys">
                    ...
                    <div class="divTit" style="width:100%;">
                        <span class="spanName">统计日期段</span>&nbsp;<%--<label class="rad">
                        <input type="radio" id="date_this_day" value="this_day"
                               name="date_select"/>本日</label>&nbsp;<label
                            class="rad">
                        <input type="radio" id="date_this_week" value="this_week"
                               name="date_select"/>本周</label>&nbsp;<label
                            class="rad">
                        <input type="radio" id="date_this_month" value="this_month"
                               name="date_select"/>本月</label>&nbsp;<label
                            class="rad">
                        <input type="radio" id="date_this_year" value="this_year"
                               name="date_select"/>本年</label>&nbsp;<label
                            class="rad">--%>
                    ...
                    <div class="divTit">
                        <span class="spanName">客户信息</span>&nbsp;
                        <input type="text" id="customerName" name="customerName" class="txt" value="客户名" initialvalue="客户名"/>&nbsp;
                        <input type="text" id="customerMobile" name="customerMobile" class="txt" value="手机号码" initialvalue="手机号码"/>
                        &nbsp;&nbsp;记录类型&nbsp;
...
<div class="divTit button_conditon"><input class="btn" type="button" id="resetSearchCondition"
            ...
            <div class="group_list">
                预收款统计结果：共<b class="blue_color"><span id="totalCount">100</span></b>&nbsp;条记录&nbsp;&nbsp;其中（收款总额<b
                    class="yellow_color"
            ...
            <div class="cuSearch">
                ...
                <div class="cartBody">
                    ...
                    <bcgogo:hasPermission permissions="WEB.STAT.CUSTOMER_DEPOSIT.STAT_PRINT">
