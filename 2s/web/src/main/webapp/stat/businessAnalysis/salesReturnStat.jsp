...
<head>
  ...
  <script type="text/javascript"
    ...
    <script type="text/javascript">
        defaultStorage.setItem(storageKey.MenuUid, "BUSINESS_ANALYSIS_REDIRECT_SALES_RETURN_STAT");
    </script>
</head>
<body class="bodyMain">
...
<div class="i_main clear">
  ...
  <jsp:include page="businessAnalysisNavi.jsp">
    <jsp:param name="currPage" value="salesReturnStat"/>
  </jsp:include>

  <div class="titBody">
    <div class="lineTitle">销售退货统计查询</div>
    <form id="itemStatisticsForm" name="itemStatisticsForm" action="businessAnalysis.do?method=getSalesReturnList"
          method="post">
      <input type="hidden" name="startPageNo" id="startPageNo" value="1">
      <input type="hidden" name="maxRows" id="maxRows" value="25">
      <input type="hidden" id="statType" name="statType" value="salesReturnStatistics"/>
    ...
    <div class="tab">
      ...
      <jsp:include page="/common/pageAJAX.jsp">
        <jsp:param name="url" value="businessAnalysis.do?method=getSalesReturnList"></jsp:param>
      ...
      <div class="shopping_btn" style="float:right; clear:right; margin-top:16px;">
          <bcgogo:hasPermission permissions="WEB.STAT.BUSINESS_ANALYSIS.SALES_RETURN_STAT_PRINT">
              <div class="btn_div_Img" id="print_div_saleReturn">
