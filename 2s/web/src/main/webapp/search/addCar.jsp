...
<script type="text/javascript">
     $(function() {
        ...
        window.parent.document.getElementById("iframe_PopupBox_1").style.display = "block";
...
//        window.parent.addHandle(document.getElementById('div_drag'), window);
    ...
    function addrow() {
        ...
        jQuery(".addcaritem:last img").css({'display':'none'});
            ...
            <c:if test="${pvDTOList != null}">
                <c:forEach items="${pvDTOList}" var="productVehicleDTO" varStatus="status">
                    <tr class="addcaritem">
                        ...
                        <td style="border-right:none;"><img src="<%=webapp%>/images/opera2.jpg"
                                                            style="display: none" onclick="addrow()"/>
                        </td>
