...
<head>
    ...
    <script type="text/javascript">
        var detailsListMultiselect = APP_BCGOGO.Module.detailsListMultiselect;
        ...
        $(document).ready(function() {
            ...
            detailsListMultiselect.changeThemes("large");
            detailsListMultiselect.setUUID(uuid);
            detailsListMultiselect.show();
            detailsListMultiselect.draw(JSON.parse(data)["history"]);
        });
    </script>
</head>
