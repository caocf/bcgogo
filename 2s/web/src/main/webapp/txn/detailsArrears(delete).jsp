...
<head>
  ...
  <script type="text/javascript">
    ...
    function sendSms(mobile, type, arrears, licenceNo, date, name) {        // type <!-- 0 保险  1 验车  2 生日-->
      ...
      var month = dates[1];
      var day = dates[2];
      window.location = encodeURI("sms.do?method=smswrite&mobile=" + $.trim(mobile) + "&type=" + type + "&money=" + arrears + "&licenceNo=" + licenceNo + "&month=" + month + "&day=" + day + "&name=" + name);
    }
...
//            window.parent.addHandle($("#div_drag")[0], window);
      ...
      // bind date-checking method to searcher
//            $("#from_searchArrear")[0].onsubmit = function(event) {
//                var startTime = $("#startDate").val();
//                var endTime = $("#endDate").val();
//                if (!startTime || !endTime) {
//                    $("#systemDialog")
//                            .html("<p>请确定时间范围</p>")
//                            .dialog({"title":"提示", modal:true});
//                    return false;
