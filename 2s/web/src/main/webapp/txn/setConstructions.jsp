...
<div class="i_main clear">
  ...
  <a class="add_new" id="addNewServiceBtn">新&nbsp;增</a>
  ...
  <div class="cuSearch">
    ...
    <div class="cartBody">
      ...
      <div class="clear i_height"></div>
      <bcgogo:ajaxPaging url="category.do?method=getCategoryItemSearch" dynamical="setConstructions"
                         postFn="initServiceItem"></bcgogo:ajaxPaging>
    </div>
...
<div id="addNewServiceDialog" class="alertMain" style="display: none">
  ...
  <div class="divTit alert_divTit">施工内容&nbsp;<input type="text" maxlength="30" class="txt" style="width:120px;" id="newServiceName"/>
  </div>
  <div class="divTit alert_divTit">营业分类&nbsp;<input type="text" class="txt" style="width:115px;" id="newCategoryName"/>
  </div>
  <div class="divTit alert_divTit">标准工时&nbsp;<input type="text" value="0" class="txt" id="newStandardHours" data-filter-zero="true"/></div>
  <div class="divTit alert_divTit">工时单价&nbsp;<input type="text" value="0" class="txt" style="width:120px;" id="newStandardUnitPrice" data-filter-zero="true"/></div>
  ...
  <div class="divTit alert_divTit">提&nbsp;&nbsp;&nbsp;&nbsp;成&nbsp;<input type="text" class="txt" value="0" id="achievementAmount" data-filter-zero="true"/></div>
  <div class="height"></div>
  <div class="button"><a class="btnSure" id="saveNewService">确&nbsp;定</a><a class="btnSure" id="cancelSaveNewService">取&nbsp;消</a>
  </div>
</div>
