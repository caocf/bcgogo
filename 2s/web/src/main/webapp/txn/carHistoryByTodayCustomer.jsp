...
<style type="text/css">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#pageNo_id").html(pn);
            $("#searchCar_id").live("click", function () {
                var endDateStr = $("#endDateStr").val();
                var endDateStr2 = $("#endDateStr2").val();
                // 滤除时间字符串内非数字的字符
...
<div class="i_supplierInfo more_supplier" id="div_show">
    ...
    <div class="i_upCenter i_two">
        <div class="i_note more_title" id="getmorehistory">今日新增车辆历史查询</div>
    ...
    <div class="i_upBody clear">
        <div class="i_main clear">
            <!--历史搜素-->
            <form:form commandName="command" action="goodsHistory.do?method=searchCarHistoryByNewVehicle" method="post" name="thisform">
            ...
            <table cellpadding="0" cellspacing="0" class="table2 tableStyle">
                ...
                <c:forEach items="${itemIndexList}" var="itemDTO" varStatus="status">
                    <tr class="table-row-original">
                        ...
                        <td>${itemDTO.services}</td>
                        <td>${itemDTO.itemName}</td>
                        <td class="txt_right">${itemDTO.orderTotalAmount}</td>
                        ...
                        <td style="border-right:none;" class="qian_blue">
                            <c:if test='${itemDTO.orderType!="WASH_BEAUTY"&&itemDTO.orderType!="RECHARGE"&&itemDTO.orderType!="WASH_MEMBER"}' var="wash">
            ...
            <c:if test="${pager != null}">
                <jsp:include page="/common/paging.jsp">
                    <jsp:param name="url" value="goodsHistory.do?method=searchCarHistoryByNewVehicle"></jsp:param>
