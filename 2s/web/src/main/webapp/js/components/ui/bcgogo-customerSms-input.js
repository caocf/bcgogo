...
// Component "defined"
    var customerSmsInput = {
        ...
        _show:function(){
            if($(".bcgogo-customerSmsInput-optionContainer li").length<=0){
                $(".bcgogo-customerSmsInput-optionContainer").css({'visibility':'hidden'});
            }
            else{
        ...
        init:function (p) {
            ...
            this._isEnableAddTask = p.hasOwnProperty("isEnableAddTask") ? p.isEnableAddTask : true;
//            this.
            ...
            var s = ""
                ...
                + "        <input class='bcgogo-customerSmsInput-name' placeholder='请输入姓名' type='text' style='margin:auto 5px auto 5px;width:100px;'/>"
                + "        <input class='bcgogo-customerSmsInput-mobile' placeholder='请输入手机号' type='text' style='margin:auto 5px auto 5px;width:100px;'/>"
                ...
                + "        <span style='color:#000'>马上发送短信</span>"
                + "        <input type='checkbox'/>"
            ...
            if (!this._isEnableAddTask) {
                $(".bcgogo-customerSmsInput-button-save", this._target).hide();
                $(".bcgogo-customerSmsInput-saveContainer input[type='checkbox']", this._target).hide();
                $(".bcgogo-customerSmsInput-saveContainer span", this._target).hide();
            }
        ...
        delData:function (userId) {
            ...
            // if there is not any item,than hidden the ul
            customerSmsInput._show();
        },
