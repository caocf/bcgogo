			...
			switch(_sType) {
				...
				case 'swipeup':
					if ( /*_bHasTouches &&*/ _bHasMoved === true /*&& _bHasSwipeGesture===true*/) {
						...
						_oDetails.type = [
							'swipe',
							'',
							(_oDetails.delta[0].lastY!=0)?((_oDetails.delta[0].lastY<=-50)?'up':''):''
						].join('');
						_$element.triggerHandler(_oDetails.type, _oDetails);
					}
					break;
				...
				case 'swiperight':
					if ( /*_bHasTouches &&*/ _bHasMoved === true /*&& _bHasSwipeGesture===true*/) {
						...
						_oDetails.type = [
							'swipe',
							(_oDetails.delta[0].lastX!=0)?((_oDetails.delta[0].lastX >= 50)?'right':''):'',
							''
						].join('');
						_$element.triggerHandler(_oDetails.type, _oDetails);
					}
				...
				case 'swipedown':
					if ( /*_bHasTouches &&*/ _bHasMoved === true /*&& _bHasSwipeGesture===true*/) {
                        ...
                        //
						//}
						//_oDetails.type = ['swipe', hor2, ver2].join('');
						_oDetails.type = [
							'swipe',
							'',
							(_oDetails.delta[0].lastY!=0)?((_oDetails.delta[0].lastY>=50)?'down':''):''
						].join('');
						_$element.triggerHandler(_oDetails.type, _oDetails);
					}
					break;
				...
				case 'swipeleft':
					if ( /*_bHasTouches &&*/ _bHasMoved === true /*&& _bHasSwipeGesture===true*/) {
						...
						_oDetails.type = [
							'swipe',
							(_oDetails.delta[0].lastX!=0)?((_oDetails.delta[0].lastX <= -50)?'left':''):'',
							''
						       ].join('');
						_$element.triggerHandler(_oDetails.type, _oDetails);
					}
