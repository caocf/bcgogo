...
//TODO 根据车型获得车辆品牌
function reGetVehicleBrand(selectVehicle, trcount, valflag) {
    if (selectVehicle == 'model' && valflag) {
        var Obj1 = document.getElementById("itemDTOs" + (trcount) + ".vehicleBrand");
        searchSuggestionForVehicleAdjustment(Obj1, document.getElementById("itemDTOs" + (trcount) + ".vehicleBrand").value,
            document.getElementById("itemDTOs" + (trcount) + ".vehicleModel").value,
            document.getElementById("itemDTOs" + (trcount) + ".vehicleYear").value,
            document.getElementById("itemDTOs" + (trcount) + ".vehicleEngine").value, trcount);
    }
}
