...
<head>
    ...
    <script type="text/javascript" src="/web/js/wx/wx_talk<%=ConfigController.getBuildVersion()%>.js"></script>
</head>
<body>
    ...
    <section class="content">
        <div class="trajectory">
            <div class="date_w">
                ...
                <div id="moreBtn" class="date"><span id="loadIcon" style="display: none;margin-right:4px;"><img
                        src="/web/images/loadinglit-2.gif"></span>查看更多消息
                </div>
            </div>
        </div>
        <div class="padding10">
            <div id="contentBody" class="content-body">
                <c:forEach items="${pushMessages}" var="pushMessage" varStatus="status">
                    <c:choose>
                        <c:when test="${pushMessage.type=='MSG_FROM_WX_USER_TO_MIRROR'||pushMessage.type == 'MSG_FROM_WX_USER_TO_SHOP'}">
                            <div class="dialogue">
            ...
            <div class="add_txt">
                <a href="#" class="w20 fl">请输入想说的话</a>
                <%--<img width="24" src="/web/images/wx_mirror_images/xiao.jpg"/>--%>
