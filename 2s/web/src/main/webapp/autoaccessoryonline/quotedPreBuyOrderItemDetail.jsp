    ...
    <div class="titBody tib_show ">
                ...
                <div class="cartBody lineBody">
                    ...
                    <div class="tb_bao item">
                        ...
                        <div class="divTit" style="position:relative;">
                            ...
                            <%--<c:if test="${not empty productDTO.promotionsDTOs}">
                                <div style="float: left;padding: 6px" class="promotions_info_td">
                                    <input type="hidden" class="productId" value="${productDTO.productLocalInfoId}"/>
                    ...
                    <div class="clear i_height"></div>
                    <c:if test="${currentPreBuyOrderQuotedCount>1}">
                        <div class="look_other">
                            <span class="green_color">当前求购单中此卖家共有${currentPreBuyOrderQuotedCount}种商品报价！</span>
                            <a class="blue_color" href="preBuyOrder.do?method=showSupplierQuotedDetailByPreBuyOrderIdAndSupplierShopId&preBuyOrderId=${preBuyOrderItemDTO.preBuyOrderId}&supplierShopId=${supplierDTO.supplierShopId}">马上查看</a>
                        </div>
                    </c:if>

                    <div class="height"></div>
                    <div class="divTit button_conditon" style="width:100%;">
                        <a class="button" style="float:right;" href="preBuyOrder.do?method=showPreBuyOrderById&preBuyOrderId=${preBuyOrderItemDTO.preBuyOrderId}">取&nbsp;消</a>
                        <a class="button" style="float:right;" id="createPurchaseOrderBtn" data-itemids="${quotedPreBuyOrderItemDTO.id}">直接下单</a>
                    </div>
                </div>
        ...
        <div class="bodyRight">
            <div class="titles buyingInfo_titles">
                ...
                <div class="list"><b class="yellow_color">${supplierDTO.name}</b><a id="QQ" data="${supplierDTO.qqArray}"></a></div>
                <div class="list">
