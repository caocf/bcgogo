                    ...
                    <div class="text_cont">
                        <table>
                            <tr>
                                ...
                                <td class="txt_edit">
                                    <textarea class="phoNumber" name="phoneNumbers"
                                              id="phoneNumbers"><%=(request.getAttribute("sendMobile") == null ? "" : request.getAttribute("sendMobile"))%>
                                    </textarea><br/>

                                    <label class="txt_lbl">共添加了<span id="phoneAmount">1</span>个手机号码;</label>
                                    <input type="button" class="add_Contacts" disabled id="addUserBtn" value="添加联系人"/>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="txt_ti">
                                    <div class="txt_bg">
                                        ...
                                        <textarea name="smsContent" id="smsContent" class="phoContent"
                                                  row="1"><%=(request.getAttribute("smsContent") == null ? "" : request.getAttribute("smsContent"))%>
                                        </textarea>
                        ...
                        <input type="hidden" id="smsType"
                               value="<%=(request.getAttribute("smsType")==null?"-1":request.getAttribute("smsType"))%>"/>
