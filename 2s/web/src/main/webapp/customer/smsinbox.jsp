    ...
    <div class="i_search">
        ...
        <div class="sms_title">
            ...
            <div class="sms_titleBody">
                <ul>
                    ...
                    <li><a class="sms_hover" href="#">收件箱</a></li>
                </ul>
            </div>
        ...
        <div class="sms_main">
            ...
            <div class="sms_mainLeft">
                ...
                <div class="i_height"></div>
                <div class="sms_leftTwo"><a href="#" class="sms_leftIcon4">收 件 箱</a></div>
            </div>
            <div class="sms_mainRight">
                <div class="sms_rightTitle">
                    <div class="sms_titleLeft"></div>
                    <div class="sms_titleCenter">
                        收 件 箱（共<span><%=request.getAttribute("inBoxSmsNumber")%></span>封）
                    </div>
                    <div class="sms_titleRight"></div>
                </div>
                ...
                <div class="sms_table">
                    <table cellpadding="0" cellspacing="0" class="sms_allNote">
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td><%=(inBoxDTO.getLicenceNo() == null ? "" : inBoxDTO.getLicenceNo())%>
                            </td>
