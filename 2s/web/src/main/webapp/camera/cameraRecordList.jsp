...
<head>
    ...
    <script type="text/javascript">
        defaultStorage.setItem(storageKey.MenuUid, "WEB.CUSTOMER_MANAGER.CAMERA_MANAGE.CAMERA_MANAGER");
    </script>
</head>
<body class="bodyMain">
<%@include file="/WEB-INF/views/header_html.jsp" %>
<div class="i_main clear">
<iframe style="width: 1000px;height:750px;border: 0" src="cameraRecord.do?method=toCameraRecordContent"></iframe>
</div>
