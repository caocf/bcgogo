...
<head>
    ...
    <script type="text/javascript" src="scripts/txnbase<%=ConfigController.getBuildVersion()%>.js"></script>
    ...
    <div class="bodyLeft">
      <ul class="leftTitle">
        <li  class="left_hover"><a href="#" class="left_register">注册</a>
          <input type="button" class="btnNum" value="<%=request.getAttribute("count")%>"/>
        </li>
