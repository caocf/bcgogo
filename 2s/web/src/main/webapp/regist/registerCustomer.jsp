...
<div class="i_main clear register_image">
    ...
    <form id="form_reg" method="post" enctype="multipart/form-data" action="shopRegister.do?method=saveShopInfo">
        ...
        <input type="hidden" id="registerShopType" value="${param.registerShopType}">
        ...
        <table cellpadding="0" cellspacing="0" class="tabRegister">
            ...
            <%--<tr>
                ...
                <td colspan="3">
                    <input type="text" class="txt" maxlength="10" id="input_owner" name="owner" node-type="owner"/>
                </td>
                <td style="text-align:left;">
                    <div class="tips" node-type="owner_tips">
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="3">
                    <input type="text" class="txt" maxlength="11" id="input_mobile" name="mobile" node-type="mobile"/>
                </td>
                <td style="text-align:left;line-height: 15px">
                    <div class="tips" node-type="mobile_tips">
                    </div>
                </td>
            </tr>--%>
            <tr>
