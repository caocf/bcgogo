...
<head>
    ...
    <script type="text/javascript">
        var mustValidate = ["name", 'address','businessScopes','storeManager','storeManagerMobile','contact_owner', 'contact_mobile', 'softPrice'];
...
<div class="i_main clear register_image">
    ...
    <form id="form_reg" method="post" enctype="multipart/form-data" action="shopRegister.do?method=saveShopInfo">
        ...
        <input type="hidden" id="registerShopType" name="registerShopType" value="SALES">
        ...
        <table cellpadding="0" cellspacing="0" class="tabRegister">
            ...
            <tr>
                ...
                <td colspan="3" style="padding:0px;">
                    ...
                    <select id="select_township" name="region" class="txt" style="width:60px; padding-left: 0px">
            ...
            <tr>
                <td>店面管理员<span class="red_color">*</span></td>
                <td><input id="input_storeManager" name="storeManager" type="text" class="txt" node-type="storeManager"></td>
                <td>手机<span class="red_color">*</span></td>
                <td><input id="input_storeManagerMobile" name="storeManagerMobile" type="text" class="txt" node-type="storeManagerMobile"></td>
                <td style="text-align:left;">
                    <div class="tips" node-type="storeManager_tips|storeManagerMobile_tips"></div>
                </td>
            </tr>
            <tr>
                <td>网址</td>
...
<div class="i_height"></div>
        ...
        <table cellpadding="0" cellspacing="0" class="tabRegister" id="contact_table">
            ...
            <tr>
                ...
                <td><input type="text" id="contacts${status.index}.name" name="contacts[${status.index}].name" class="txt" node-type="<c:choose><c:when test="${contact.mainContact == 1}">contact_owner</c:when><c:otherwise>contact_name</c:otherwise></c:choose>"></td>
                <td>手机<c:if test="${contact.mainContact == 1}"><span class="red_color">*</span></c:if></td>
                <td><input type="text" class="txt" id="contacts${status.index}.mobile" name="contacts[${status.index}].mobile" node-type="<c:choose><c:when test="${contact.mainContact == 1}">contact_mobile</c:when><c:otherwise>contact_phone</c:otherwise></c:choose>"></td>
                <%--<td style="text-align:left; line-height:15px;">
            ...
            <tr>
                <td>Email</td>
                <td><input type="text" class="txt" id="contacts${status.index}.email" name="contacts[${status.index}].email" node-type="contact_email" maxlength="50"></td>
                <td>QQ</td>
                <td><input type="text" class="txt" id="contacts${status.index}.qq" name="contacts[${status.index}].qq" node-type="contact_qq"></td>
                <c:if test="${contact.mainContact == 1}">
                <td style="text-align:left;">
        ...
        <table cellpadding="0" cellspacing="0" class="tabRegister">
            ...
            <tr>
                <td>软件销售价<span class="red_color">*</span></td>
                <td colspan="3"><input type="text" class="txt" name="softPrice" id="input_softPrice" value="" node-type="softPrice"/></td>
                <td style="text-align:left;">
                    <div class="tips" node-type="softPrice_tips"></div>
                </td>
            </tr>
            <tr>
                <td colspan="5" class="btnSure">
                    <a id="registerBtn">确认注册</a>
                    <a href="shopRegister.do?method=registerMain&registerType=${param.paramRegisterType}">返回重新选择版本</a>
                </td>
            </tr>
            <tr class="registerDescription">
                <td></td>
