...
<head>
    ...
    <script type="text/javascript" src="js/page/remind/message/mileage/shopMileageInfoList<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript" src="js/exportExcel<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript">
        defaultStorage.setItem(storageKey.MenuUid, "WEB.SCHEDULE.SHOP_MILEAGE_INFO.BASE");
    </script>
</head>
<body class="bodyMain">
        ...
        <div class="score_list">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="score_table2" id="shopFaultInfoTables">
                <tr>
                    ...
                    <th style="width: 80px">下次保养里程</th>
                    <th style="width: 80px">当前里程</th>
                    <th style="width: 80px">距保养里程</th>
            ...
            <div style="float: right;margin: 12px 0 10px 10px;">
                <bcgogo:ajaxPaging
                        url="shopMileageInfo.do?method=searchShopMileageInfoList"
