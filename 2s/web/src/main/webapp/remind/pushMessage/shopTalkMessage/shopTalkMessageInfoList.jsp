...
<head>
    ...
    <script type="text/javascript" src="js/page/remind/message/talk/shopTalkMessageInfoList<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript" src="js/exportExcel<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript">
        defaultStorage.setItem(storageKey.MenuUid, "WEB.SCHEDULE.SHOP_TALK_INFO.BASE");
    </script>
</head>
<body class="bodyMain">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_search">
                ...
                <tr>
                    ...
                    <%--<td>--%>
                        ...
                        <%--&lt;%&ndash;<label class="rad"><input autocomplete="off" type="checkbox" ${isSendMessage == 'YES'?"checked='checked'":"" } name="isSendMessage"/>&nbsp;已发消息</label>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<label class="rad"><input autocomplete="off" type="checkbox" ${isCreateAppointOrder == 'YES'?"checked='checked'":"" } name="isCreateAppointOrder"/>&nbsp;已预约</label>&ndash;%&gt;--%>
        ...
        <div class="score_list">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="score_table2" id="shopFaultInfoTables">
                <tr>
                    ...
                    <th style="width: 120px">车主信息</th>
                    <th style="width: 120px">客户信息</th>
                    <th style="width: 120px">车主消息时间</th>
                    <th style="width: 140px">车主最近一次消息</th>
                    <th style="width: 120px">回复时间</th>
                    <th style="width: 140px">最好一次回复内容</th>
            ...
            <div style="float: right;margin: 12px 0 10px 10px;">
                <bcgogo:ajaxPaging
                        url="shopTalkMessageInfo.do?method=searchShopTalkMessageInfoList"
