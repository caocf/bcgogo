...
<head>
	...
	<script type="text/javascript" src="js/page/remind/impact/shopImpactInfoList<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript" src="js/exportExcel<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript">
        defaultStorage.setItem(storageKey.MenuUid, "WEB.SCHEDULE.SHOP_IMPACT_INFO.BASE");
    </script>
</head>
<body class="bodyMain">
...
<div class="i_main clear">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="score_table2" id="shopFaultInfoTables">
        <tr>
            ...
            <th style="width: 120px">碰撞时间</th>
            <th style="width: 120px">碰撞地点</th>
            <th style="width: 50px">碰撞视频</th>
            <th style="width: 140px">车辆信息</th>
    ...
    <div style="float: right;margin: 12px 0 10px 10px;">
        <bcgogo:ajaxPaging
                url="shopImpactInfo.do?method=searchShopImpactInfoList"
...
<%@include file="/WEB-INF/views/footer_html.jsp" %>
     ...
     <div id="closemap" style="width:30px;font-weight:bold;background-color:yellow;display:none;
                                margin-left:910px;cursor: pointer;color:black;position:relative;;top:-550px;" title="关闭">
        关闭
     </div>
     <div id="allmap" style="position:relative;top:-550px;width: 700px;height: 400px;border:5px solid green;display:none;margin: 0 auto;">
    </div>
