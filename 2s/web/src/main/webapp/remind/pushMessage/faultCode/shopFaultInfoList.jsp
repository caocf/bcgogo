...
<head>
    ...
    <script type="text/javascript" src="js/page/remind/message/faultCode/shopFaultInfoList<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript" src="js/exportExcel<%=ConfigController.getBuildVersion()%>.js"></script>
    <script type="text/javascript">
        defaultStorage.setItem(storageKey.MenuUid, "WEB.SCHEDULE.SHOP_FAULT_INFO.BASE");
    </script>
</head>
<body class="bodyMain">
...
<div class="i_main clear">
    <div class="mainTitles">
        <div class="titleWords">事故故障提醒</div>
    </div>
    <div class="clear"></div>
    <div id="todo_content">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_search">
            ...
            <tr>
                ...
                <td>
                    ...
                    <label class="rad"><input autocomplete="off" type="checkbox" ${isDeleted == 'YES'?"checked='checked'":"" } name="isDeleted"/>&nbsp;已删除</label>
                </td>
            </tr>
            <tr>
                <th>车牌号：</th>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="score_table2" id="shopFaultInfoTables">
        <tr>
            ...
            <th style="width: 120px">发生时间</th>
            <th style="width: 60px">类型</th>
            <th style="width: 250px">详细描述</th>
            <th style="width: 150px">车辆信息</th>
            <th style="width: 140px">客户端手机号</th>
            <th style="width: 170px">所属客户</th>
    ...
    <div style="float: right;margin: 12px 0 10px 10px;">
        <bcgogo:ajaxPaging
                url="shopFaultInfo.do?method=searchShopFaultInfoList"
                data="{startPageNo:'1',maxRows:15,ids:'${shopFaultInfoId}',isUntreated:'${isUntreated}',isSendMessage:'${isSendMessage}',
    ...
    <input autocomplete="off" type="hidden" name="maxRows" id="sfi_maxRows" value="15" />
