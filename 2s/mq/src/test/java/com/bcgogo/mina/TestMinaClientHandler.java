...
//
//public class TestMinaClientHandler extends IoHandlerAdapter {
//    private static final Logger LOG = LoggerFactory.getLogger(TestMinaClientHandler.class);
//
//    /**
//     * 当客户端接受到消息时
//     */
...
//        LOG.info("client:receive data,type={}, bData={}",data[4],new String(bData,"UTF-8"));
//    }
//
//    /**
//     * 当一个客户端被关闭时
