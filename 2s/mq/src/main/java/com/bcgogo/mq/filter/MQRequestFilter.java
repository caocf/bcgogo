 ...
 * Time: 上午10:17
 */
public class MQRequestFilter implements Filter{
   private static final Logger LOG = LoggerFactory.getLogger(MQRequestFilter.class);
