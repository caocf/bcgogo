            ...
            <div class="rightMain clear">
                ...
                <div  id="div_show">
                    ...
                    <div class="i_upCenter">
                        <div class="" id="div_drag">查看公共模板</div>

                    </div>
                    <form:form id="template_form" action="weChat.do?method=???"
                    ...
                    <div class="bodyRight">
                        ...
                        <table cellpadding="0" id="configTable" cellspacing="0" class="configTable audit-article-detail">
                            ...
                            <tr>
                                ...
                                <td style="height:20px;width: 224px;">${wxMsg.title}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><textarea id="description" name="description" style="height: 86px; width: 224px;" readonly="true">${wxMsg.description}</textarea>  </td>
                        ...
                        <div class="more_his">
                            ...
                            <input type="button" value="不通过" onclick="chancel()" class="rightSearch" id="cancleBtn"/>
                        </div>
                    </div>
                </div>
                </form:form>
