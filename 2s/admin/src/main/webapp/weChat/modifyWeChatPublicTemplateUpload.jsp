            ...
            <div class="rightMain clear">
                ...
                <div  id="div_show">
                    ...
                    <div class="i_upCenter">
                        <div class="" id="div_drag">修改公共模板</div>

                    </div>
                    <form:form id="template_form" action="weChat.do?method=modifyWeChat" commandName="wxArticleTemplate"
                    ...
                    <div class="i_upBody">
                        <table cellpadding="0" id="configTable" cellspacing="0" class="configTable">
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="title" name="title" value="${wxArticleTemplate.title}" style="height:20px;width: 224px"/>
                                </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td><textarea id="description" name="description"  style="height: 86px; width: 224px;">${wxArticleTemplate.description}</textarea>  </td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            ...
                            <tr>
                                <img src="${wxArticleTemplate.picUrl}" style="width: 227px;height: 84px;margin-left:66px;margin-bottom: 50px;margin-bottom: 40px">
                            </tr>

                        </table>
                        <div class="height"></div>
                        <div class="more_his">
                            <input type="button" value="确认" onclick="confirmThis()" class="rightSearch" id="confirmBtn"/>
