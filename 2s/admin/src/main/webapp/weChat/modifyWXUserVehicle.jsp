            ...
            <div class="rightMain clear">
                ...
                <div  id="div_show">
                    ...
                    <div class="i_upCenter">
                        <div class="" id="div_drag">修改车辆信息</div>

                    </div>
                    <form:form id="template_form" action="weChat.do?method=modifyVehicle" commandName="WXUserVehicleDTO"
                    ...
                    <div class="i_upBody">
                        <table cellpadding="0" id="configTable" cellspacing="0" class="configTable">
                            <col width="100">
                            <col  width="100"/>
                            <input type="hidden" id="id" name="id" value="${wXUserVehicleDTO.idStr}">
                            <input type="hidden" id="openId" name="openId" value="${wXUserVehicleDTO.openId}">
                            <input type="hidden" id="page_type"  value="EDIT"/>
                            <input type="hidden" id="province" value="${wXUserVehicleDTO.province}"/>
                            <input type="hidden" id="city" value="${wXUserVehicleDTO.city}"/>
                            <tr>
                                <td class="label">车牌号<img src="images/star.jpg"></td>
                                <td><input type="text" id="vehicleNo" name="vehicleNo" value="${wXUserVehicleDTO.vehicleNo}" style="height:20px;width: 224px"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="label">车架号<img src="images/star.jpg"></td>
                                <td><input type="text" id="vin" name="vin" value="${wXUserVehicleDTO.vin}" style="height:20px;width: 224px"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="label">发动机号<img src="images/star.jpg"></td>
                                <td><input type="text" id="engineNo" name="engineNo" value="${wXUserVehicleDTO.engineNo}" style="height:20px;width: 224px"/>
                                </td>
                            </tr>
                            <tr>
