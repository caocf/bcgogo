...
<head>
   <title>后台管理系统——代理商管理</title>
    ...
    <script type="text/javascript" src="js/txnbase.js"></script>
        ...
        $(document).ready(function(){
            $(".font").live("click",function(){
               // jQuery(this).parent().parent().css('display','none');
                $.ajax({
                    type:"POST",
                    url:$("#basePath").val()+"beshop.do?method=deleteBlance",
                    data:{id:$("#id").val()},
                    success:function(data){
                            window.location=$("#basePath").val()+"beshop.do?method=getSms";
                    }
                });
            ...
            <ul class="leftTitle">
               <li ><a href="<%=basePath%>beshop.do?method=shoplist" class="left_register">注册</a>
                ...
                <li><a href="#" class="left_recruit">招聘</a><input type="button" class="btnNum" value="5"/></li>
                 <li class="left_hover"><a href="<%=basePath%>beshop.do?method=getSms" class="left_recharge">充值</a><input type="button" class="btnNum" value="28"/></li>
