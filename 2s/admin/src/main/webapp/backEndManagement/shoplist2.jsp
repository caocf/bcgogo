...
<div class="main">
  ...
  <div class="top">
    <div class="top_left"><div class="top_name">统购后台管理系统</div><div class="top_image"></div>你好，<span>张三</span>|<a href="#">退出</a></div>
  ...
  <div class="body">
    ...
    <%--<div class="bodyLeft">--%>
      <%--<ul class="leftTitle">--%>
                <%--<li class="left_hover"><a href="<%=basePath%>beshop.do?method=shoplist" class="left_register">注册</a>--%>
                ...
                <%--<li><a href="<%=basePath%>agents.do?method=getAgents" class="left_agaent">代理商</a><input type="button" class="btnNum" value="25"/></li>--%>
       ...
       <thead>
        ...
        <c:forEach items="${shoplist}" var="shop" varStatus="status">
           ...
           <c:otherwise>
             <tr>
                ...
                <td><a href="beshop.do?method=shopaudit&shopId=${shop.id}" class="font">点击详情</a></td>
        ...
        <%--  <div class="fist_page"></div>
          ...
          <div class="last_page"></div>   --%>
           ...
           %>
          <div class="fist_page" onclick="prePage('shoplist2','<%=pageNo%>')"></div>
          <%
            ...
            if(pageCount!=null&&pageNo!=null){
                for(int m=1;m<=pageCount;m++){
                    if(m==pageNo){
          %>
                    <div class="i_leftCountHover"><%=m%></div>
          <%}else{%>
                    <div class="" onclick="page('shoplist2','<%=m%>')"><%=m%></div>
          <%
                    }
                }
            }
          %>
          <div class="last_page" onclick="nextPage('shoplist2','<%=pageNo%>','<%=pageCount%>')"></div>
        </div>
      </div>
      <!--分页结束-->
      <!--内容结束-->
