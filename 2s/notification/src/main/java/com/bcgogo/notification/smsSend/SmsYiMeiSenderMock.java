...
* Time: 下午9:42
*/
public class SmsYiMeiSenderMock extends SmsYiMeiSender {
  private static final Logger LOG = LoggerFactory.getLogger(SmsYiMeiSenderMock.class);
  public static int code = 0;

  public static void setCode(int code) {
    SmsYiMeiSenderMock.code = code;
  }
  ...
  public SmsSendResult sendSms(SmsSendDTO smsSendDTO) throws Exception {
    ...
    smsSendResult.setSmsSendKind(SmsSendKind.YI_MEI_MOCK);
    return smsSendResult;
  }
