 ...
 */
public class GSMUMPushAdapter {
  private static final Logger LOG = LoggerFactory.getLogger(GSMUMPushAdapter.class);
  ...
  private static void init() {
    if (_initialize.compareAndSet(true, false)) {
      try {
        appkey = ConfigUtils.getGSMUMAppkey();
        appMasterSecret = ConfigUtils.getGSMUMAppMasterSeret();
