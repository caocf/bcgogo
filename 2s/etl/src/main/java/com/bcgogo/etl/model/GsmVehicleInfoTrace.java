 ...
 */
@Entity
@Table(name = "gsm_vehicle_info_trace")
public class GsmVehicleInfoTrace extends LongIdentifier {
  ...
  public void setGsmvehicleInfo(GsmVehicleInfo gsmVehicleInfo) {
    if(gsmVehicleInfo != null){
      setId(gsmVehicleInfo.getId());
      setEmi(gsmVehicleInfo.getEmi());
      setAppUserNo(gsmVehicleInfo.getAppUserNo());
      setState(gsmVehicleInfo.getState());
      setAppPassword(gsmVehicleInfo.getAppPassword());
      setLoad(gsmVehicleInfo.getLoad());
      setEct(gsmVehicleInfo.getEct());
      setShrtft1(gsmVehicleInfo.getShrtft1());
      setLongft1(gsmVehicleInfo.getLongft1());
      setMap(gsmVehicleInfo.getMap());
      setRpm(gsmVehicleInfo.getRpm());
      setVss(gsmVehicleInfo.getVss());
      setSparkAdv(gsmVehicleInfo.getSparkAdv());
      setIat(gsmVehicleInfo.getIat());
      setMaf(gsmVehicleInfo.getMaf());
      setTps(gsmVehicleInfo.getTps());
      setMilDist(gsmVehicleInfo.getMilDist());
      setFuelLvl(gsmVehicleInfo.getFuelLvl());
      setBaro(gsmVehicleInfo.getBaro());
      setVpwr(gsmVehicleInfo.getVpwr());
      setIfe(gsmVehicleInfo.getIfe());
      setRuntime(gsmVehicleInfo.getRuntime());
      setAdMil(gsmVehicleInfo.getAdMil());
      setAdFeh(gsmVehicleInfo.getAdFeh());
      setSpwr(gsmVehicleInfo.getSpwr());
      setRdtcn(gsmVehicleInfo.getRdtcn());
      setRdtc(gsmVehicleInfo.getRdtc());
      setGsmVehicleStatus(gsmVehicleInfo.getGsmVehicleStatus());
      setOrgInfo(gsmVehicleInfo.getOrgInfo());
      setMaxr(gsmVehicleInfo.getMaxr());
      setMaxs(gsmVehicleInfo.getMaxs());
      setBadh(gsmVehicleInfo.getBadh());
      setCacafe(gsmVehicleInfo.getCacafe());
      setCactfe(gsmVehicleInfo.getCactfe());
      setCactrfe(gsmVehicleInfo.getCactrfe());
      setTrmil(gsmVehicleInfo.getTrmil());
      setDemil(gsmVehicleInfo.getDemil());
      setDrit(gsmVehicleInfo.getDrit());
      setIdlet(gsmVehicleInfo.getIdlet());
      setRpdtc(gsmVehicleInfo.getRpdtc());
      setUploadTime(gsmVehicleInfo.getUploadTime());
      setUploadServerTime(gsmVehicleInfo.getUploadServerTime());
    }
  }
