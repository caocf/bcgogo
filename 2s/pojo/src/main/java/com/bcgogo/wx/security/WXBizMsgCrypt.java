...
import com.bcgogo.wx.WXXMLParse;
...
public class WXBizMsgCrypt {
  public static final Logger LOG = LoggerFactory.getLogger(WXBizMsgCrypt.class);
  ...
  public WXBizMsgCrypt(WXAccountDTO accountDTO) throws AesException {
    String encodingAesKey = accountDTO.getEncodingKey();
    if (encodingAesKey.length() != 43) {
      throw new AesException(AesException.IllegalAesKey);
    }
