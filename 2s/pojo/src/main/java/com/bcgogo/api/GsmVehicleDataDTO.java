...
public class GsmVehicleDataDTO {
  ...
  private String gpsMile;//通过gps计算的里程
  ...
  public GsmVehicleInfoDTO toGsmVehicleInfoDTO() {
    GsmVehicleInfoDTO gsmVehicleInfoDTO = new GsmVehicleInfoDTO();
    gsmVehicleInfoDTO.setState(NumberUtil.intValue(getVehicleStatus()));
    gsmVehicleInfoDTO.setVss(getVss());
    gsmVehicleInfoDTO.setSpwr(getSpwr());
    gsmVehicleInfoDTO.setEct(getWbtm());
    gsmVehicleInfoDTO.setRpm(getRpm());
    gsmVehicleInfoDTO.setCurMil(getCurMil());
    gsmVehicleInfoDTO.setIfe(getaOilWear());
//    gsmVehicleInfoDTO.setBadh();
//    gsmVehicleInfoDTO.setDrit();
//    gsmVehicleInfoDTO.setVpwr(getv);
    return gsmVehicleInfoDTO;
  }

  public RescueDTO toRescueDTO() {
    RescueDTO rescueDTO = new RescueDTO();
    rescueDTO.setUploadTime(getUploadTime());
    rescueDTO.setLat(getLat());
    rescueDTO.setLon(getLon());
    rescueDTO.setRdtc(getRdtc());
    return rescueDTO;
  }
