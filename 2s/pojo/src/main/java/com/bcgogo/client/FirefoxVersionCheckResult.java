 ...
 * 当前火狐浏览器是否需要升级
 */
public class FirefoxVersionCheckResult {
  private Long shopId;
  private String userNo;
  private String localVersion;   //参数回传
  private String recentVersion;  //最新版本
  private Boolean needUpdate;     //是否需要升级
  private String updateUrl;       //更新文件地址

  public FirefoxVersionCheckResult() {
    super();
  }

  public FirefoxVersionCheckResult(Long shopId, String userNo, String localVersion, Boolean needUpdate) {
