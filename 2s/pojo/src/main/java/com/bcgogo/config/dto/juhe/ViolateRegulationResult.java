...
public class ViolateRegulationResult {
  ...
  private Map<String, ApiArea> juheCityCodeAreaRelation = new HashMap<String, ApiArea>();
  ...
  public Map<String, ApiArea> getJuheCityCodeAreaRelation() {
    return juheCityCodeAreaRelation;
  }

  public void setJuheCityCodeAreaRelation(Map<String, ApiArea> juheCityCodeAreaRelation) {
    this.juheCityCodeAreaRelation = juheCityCodeAreaRelation;
  }
}
