...
public enum PushMessageType {
  ...
  //对话消息 4s店铺-->客户端
  MSG_FROM_SHOP_TO_WX_USER,
  //微信-->4s
  MSG_FROM_WX_USER_TO_SHOP,
  ...
  public static PushMessageType[] getAppUserPushMessage() {
    return new PushMessageType[]{SHOP_CHANGE_APPOINT, SHOP_FINISH_APPOINT, SHOP_ACCEPT_APPOINT,CUSTOM_MESSAGE_2_APP,
        ...
        APP_VEHICLE_MAINTAIN_TIME, APP_VEHICLE_INSURANCE_TIME, APP_VEHICLE_EXAMINE_TIME,SHOP_QUOTE_TO_APP,
//      VEHICLE_FAULT_2_APP,
      SHOP_ADVERT_TO_APP,
        VIOLATE_REGULATION_RECORD_2_APP ,MSG_FROM_WX_USER_TO_MIRROR
    };
  }

  public static PushMessageType[] getAppUserPushMessageWithOutTalk() {
    return new PushMessageType[]{SHOP_CHANGE_APPOINT, SHOP_FINISH_APPOINT, SHOP_ACCEPT_APPOINT,CUSTOM_MESSAGE_2_APP,
        SHOP_REJECT_APPOINT, SHOP_CANCEL_APPOINT, OVERDUE_APPOINT_TO_APP, SOON_EXPIRE_APPOINT_TO_APP, APP_VEHICLE_MAINTAIN_MILEAGE,
   ...
   public static PushMessageType[] getMirrorServicePushMessageTypes() {
    PushMessageType[] types = {
      PushMessageType.APP_VEHICLE_MAINTAIN_MILEAGE,
      PushMessageType.APP_VEHICLE_MAINTAIN_TIME,
      PushMessageType.APP_VEHICLE_INSURANCE_TIME,
      PushMessageType.APP_VEHICLE_EXAMINE_TIME,
      PushMessageType.VIOLATE_REGULATION_RECORD_2_APP,
      PushMessageType.SOON_EXPIRE_APPOINT_TO_APP,
      PushMessageType.OVERDUE_APPOINT_TO_APP,
      PushMessageType.VEHICLE_FAULT_2_APP
    };
    return types;
  }
