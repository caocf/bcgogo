...
public enum ValidateMsg {
  ...
  APP_ENQUIRY_DESCRIPTION_TOO_LONG("询价单详情最多允许" + ValidateConstant.ENQUIRY_DESCRIPTION_MAX_LENGTH + "个字，请重新填写"),
  APP_ENQUIRY_IMAGES_TOO_MUCH("询价单照片最多允许" + ValidateConstant.ENQUIRY_IMAGES_MAX_SIZE + "张，请重新填写"),
  APP_ENQUIRY_TARGET_SHOP_TOO_MUCH("询价单发送店铺最多允许" + ValidateConstant.ENQUIRY_TARGET_SHOP_MAX_SIZE + "家，请重新填写"),
  APP_ENQUIRY_APP_USER_MOBILE_TOO_LONG("询价单手机最多允许" + ValidateConstant.ENQUIRY_APP_USER_MOBILE_MAX_LENGTH + "个字，请重新填写"),
  APP_ENQUIRY_APP_USER_MOBILE_ILLEGAL("询价单手机号格式不正确，请重新填写"),
  APP_ENQUIRY_APP_VEHICLE_NO_ILLEGAL("询价单车牌号格式不正确，请重新填写"),
  APP_ENQUIRY_APP_VEHICLE_NO_EMPTY("询价单车牌号不允许为空，请重新填写"),
  APP_ENQUIRY_APP_USER_NAME_TOO_LONG("询价单联系人最多允许" + ValidateConstant.ENQUIRY_APP_USER_NAME_MAX_LENGTH + "个字，请重新填写"),
