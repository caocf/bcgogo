 ...
 */
@Entity
@Table(name = "business_stat")
public class BusinessStat extends LongIdentifier {
  ...
  public BusinessStat(BusinessStatDTO businessStatDTO) {
  ...
  public BusinessStat fromDTO(BusinessStatDTO businessStatDTO,boolean setId) {
    if (setId) {
      this.setId(businessStatDTO.getId());
    }
    this.setShopId(businessStatDTO.getShopId());
