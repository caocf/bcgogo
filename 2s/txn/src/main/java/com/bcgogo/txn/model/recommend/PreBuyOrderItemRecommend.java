...
@Entity
@Table(name = "pre_buy_order_item_recommend")
public class PreBuyOrderItemRecommend extends LongIdentifier{
  private Long shopId;
  ...
  public void fromDTO(PreBuyOrderItemRecommendDTO preBuyOrderItemRecommendDTO){
  ...
  public PreBuyOrderItemRecommendDTO toDTO(){
    PreBuyOrderItemRecommendDTO preBuyOrderItemRecommendDTO = new PreBuyOrderItemRecommendDTO();
    preBuyOrderItemRecommendDTO.setShopId(this.getShopId());


    preBuyOrderItemRecommendDTO.setSeedProductName(this.getSeedProductName());
    preBuyOrderItemRecommendDTO.setSeedProductBrand(this.getSeedProductBrand());
    preBuyOrderItemRecommendDTO.setSeedProductModel(this.getSeedProductModel());
    preBuyOrderItemRecommendDTO.setSeedProductSpec(this.getSeedProductSpec());
    preBuyOrderItemRecommendDTO.setSeedProductVehicleBrand(this.getSeedProductVehicleBrand());
    preBuyOrderItemRecommendDTO.setSeedProductVehicleModel(this.getSeedProductVehicleModel());

    preBuyOrderItemRecommendDTO.setMatchedProductName(this.getMatchedProductName());
    preBuyOrderItemRecommendDTO.setMatchedProductBrand(this.getMatchedProductBrand());
    preBuyOrderItemRecommendDTO.setMatchedProductModel(this.getMatchedProductModel());
    preBuyOrderItemRecommendDTO.setMatchedProductSpec(this.getMatchedProductSpec());
    preBuyOrderItemRecommendDTO.setMatchedProductVehicleBrand(this.getMatchedProductVehicleBrand());
    preBuyOrderItemRecommendDTO.setMatchedProductVehicleModel(this.getMatchedProductVehicleModel());

    preBuyOrderItemRecommendDTO.setPreBuyOrderId(this.getPreBuyOrderId());
    preBuyOrderItemRecommendDTO.setPreBuyOrderItemId(this.getPreBuyOrderItemId());
    preBuyOrderItemRecommendDTO.setPreBuyOrderShopId(this.getPreBuyOrderShopId());
    preBuyOrderItemRecommendDTO.setId(this.getId());
    preBuyOrderItemRecommendDTO.setCustomScore(this.getCustomScore());
    preBuyOrderItemRecommendDTO.setEditDate(this.getEditDate());
    preBuyOrderItemRecommendDTO.setMatchingRule(this.getMatchingRule());
    return preBuyOrderItemRecommendDTO;
  }
